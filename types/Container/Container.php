...
assertType('Kasi\Config\Repository', $container->makeWith(Repository::class));

assertType('Kasi\Config\Repository', $container->build(Repository::class));
assertType('Kasi\Config\Repository', $container->build(function (Container $container, array $parameters) {
