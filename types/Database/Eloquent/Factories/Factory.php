...
/** @extends Kasi\Database\Eloquent\Factories\Factory<User> */
...
assertType('Kasi\Database\Eloquent\Collection<int, User>', $factory->createMany([['string' => 'string']]));
assertType('Kasi\Database\Eloquent\Collection<int, User>', $factory->createMany(3));
assertType('Kasi\Database\Eloquent\Collection<int, User>', $factory->createMany());

assertType('Kasi\Database\Eloquent\Collection<int, User>', $factory->createManyQuietly([['string' => 'string']]));
assertType('Kasi\Database\Eloquent\Collection<int, User>', $factory->createManyQuietly(3));
assertType('Kasi\Database\Eloquent\Collection<int, User>', $factory->createManyQuietly());

assertType('Kasi\Database\Eloquent\Collection<int, User>|User', $factory->create());
assertType('Kasi\Database\Eloquent\Collection<int, User>|User', $factory->create(['string' => 'string']));
assertType('Kasi\Database\Eloquent\Collection<int, User>|User', $factory->create(function ($attributes) {
    assertType('array<string, mixed>', $attributes);

    return ['string' => 'string'];
}));

assertType('Kasi\Database\Eloquent\Collection<int, User>|User', $factory->createQuietly());
assertType('Kasi\Database\Eloquent\Collection<int, User>|User', $factory->createQuietly(['string' => 'string']));
assertType('Kasi\Database\Eloquent\Collection<int, User>|User', $factory->createQuietly(function ($attributes) {
    assertType('array<string, mixed>', $attributes);

    return ['string' => 'string'];
}));

assertType('Closure(): (Kasi\Database\Eloquent\Collection<int, User>|User)', $factory->lazy());
assertType('Closure(): (Kasi\Database\Eloquent\Collection<int, User>|User)', $factory->lazy(['string' => 'string']));
...
assertType('Kasi\Database\Eloquent\Collection<int, User>|User', $factory->make());
assertType('Kasi\Database\Eloquent\Collection<int, User>|User', $factory->make(['string' => 'string']));
assertType('Kasi\Database\Eloquent\Collection<int, User>|User', $factory->make(function ($attributes) {
    assertType('array<string, mixed>', $attributes);
...
assertType('Kasi\Database\Eloquent\Factories\Factory<User>', $factory::factoryForModel(User::class));
assertType('class-string<Kasi\Database\Eloquent\Factories\Factory<User>>', $factory->resolveFactoryName(User::class));
