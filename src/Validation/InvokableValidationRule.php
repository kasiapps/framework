...
use Kasi\Contracts\Validation\InvokableRule;
...
use Kasi\Translation\CreatesPotentiallyTranslatedStrings;
...
class InvokableValidationRule implements Rule, ValidatorAwareRule
{
     ...
     *
     * @var \Kasi\Contracts\Validation\ValidationRule|\Kasi\Contracts\Validation\InvokableRule
     */
    protected $invokable;
     ...
     *
     * @param  \Kasi\Contracts\Validation\ValidationRule|\Kasi\Contracts\Validation\InvokableRule  $invokable
     * @return void
     */
     ...
     *
     * @param  \Kasi\Contracts\Validation\ValidationRule|\Kasi\Contracts\Validation\InvokableRule  $invokable
     * @return \Kasi\Validation\InvokableValidationRule
     */
     ...
     *
     * @return \Kasi\Contracts\Validation\ValidationRule|\Kasi\Contracts\Validation\InvokableRule
     */
