...
class StartSession
{
     ...
     * The session manager.
     *
     * @var \Kasi\Session\SessionManager
     */
    protected $manager;
     ...
     *
     * @param  \Kasi\Session\SessionManager  $manager
    ...
    protected function handleStatefulRequest(Request $request, $session, Closure $next)
    {
        ...
        // so that the data is ready for an application. Note that the Kasi sessions
        // do not make use of PHP "native" sessions in any way since they are crappy.
        $request->setKasiSession(
