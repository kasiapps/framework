...
use Kasi\Contracts\Cache\Factory as CacheFactory;
...
use Kasi\Contracts\Queue\ShouldBeUniqueUntilProcessing;
use Kasi\Database\Eloquent\ModelNotFoundException;
use Kasi\Log\Context\Repository as ContextRepository;
use Kasi\Pipeline\Pipeline;
...
class CallQueuedHandler
{
     ...
     *
     * @param  \Kasi\Contracts\Bus\Dispatcher  $dispatcher
    ...
    protected function ensureUniqueJobLockIsReleasedViaContext()
    {
        ...
        [$store, $key] = [
            $context->getHidden('kasi_unique_job_cache_store'),
            $context->getHidden('kasi_unique_job_key'),
        ];
