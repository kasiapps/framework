...
use Kasi\Contracts\Cache\Repository as CacheContract;
use Kasi\Contracts\Debug\ExceptionHandler;
use Kasi\Contracts\Events\Dispatcher;
use Kasi\Contracts\Queue\Factory as QueueManager;
use Kasi\Database\DetectsLostConnections;
use Kasi\Queue\Events\JobAttempted;
use Kasi\Queue\Events\JobExceptionOccurred;
use Kasi\Queue\Events\JobPopped;
use Kasi\Queue\Events\JobPopping;
use Kasi\Queue\Events\JobProcessed;
use Kasi\Queue\Events\JobProcessing;
use Kasi\Queue\Events\JobReleasedAfterException;
use Kasi\Queue\Events\JobTimedOut;
use Kasi\Queue\Events\Looping;
use Kasi\Queue\Events\WorkerStopping;
...
class Worker
{
     ...
     *
     * @param  \Kasi\Contracts\Queue\Factory  $manager
     * @param  \Kasi\Contracts\Events\Dispatcher  $events
     * @param  \Kasi\Contracts\Debug\ExceptionHandler  $exceptions
     ...
     * @param  string  $queue
     * @param  \Kasi\Queue\WorkerOptions  $options
     * @return int
     */
     ...
     *
     * @param  \Kasi\Contracts\Queue\Queue  $connection
     * @param  string  $queue
     * @return \Kasi\Contracts\Queue\Job|null
     */
    ...
    {
        if ($this->cache) {
            return $this->cache->get('kasi:queue:restart');
        }
    }
     ...
     *
     * @param  int  $status
     * @param  \Kasi\Queue\WorkerOptions|null  $options
     * @return never
     */
     ...
     *
     * @param  \Kasi\Contracts\Queue\Job  $job
     * @return \Kasi\Queue\MaxAttemptsExceededException
     */
     ...
     *
     * @param  \Kasi\Contracts\Queue\Job  $job
     * @return \Kasi\Queue\TimeoutExceededException
     */
     ...
     *
     * @return \Kasi\Contracts\Queue\Factory
     */
