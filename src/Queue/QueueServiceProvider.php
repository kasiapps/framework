...
use Kasi\Queue\Connectors\BeanstalkdConnector;
use Kasi\Queue\Connectors\DatabaseConnector;
use Kasi\Queue\Connectors\NullConnector;
use Kasi\Queue\Connectors\RedisConnector;
use Kasi\Queue\Connectors\SqsConnector;
use Kasi\Queue\Connectors\SyncConnector;
use Kasi\Queue\Failed\DatabaseFailedJobProvider;
use Kasi\Queue\Failed\DatabaseUuidFailedJobProvider;
use Kasi\Queue\Failed\DynamoDbFailedJobProvider;
use Kasi\Queue\Failed\FileFailedJobProvider;
use Kasi\Queue\Failed\NullFailedJobProvider;
...
class QueueServiceProvider extends ServiceProvider implements DeferrableProvider
{
     ...
     *
     * @param  \Kasi\Queue\QueueManager  $manager
     * @return void
     */
     ...
     *
     * @param  array  $config
     * @return \Kasi\Queue\Failed\DatabaseFailedJobProvider
     */
     ...
     *
     * @param  array  $config
     * @return \Kasi\Queue\Failed\DatabaseUuidFailedJobProvider
     */
     ...
     *
     * @param  array  $config
     * @return \Kasi\Queue\Failed\DynamoDbFailedJobProvider
     */
