...
use Kasi\Contracts\Queue\ClearableQueue;
use Kasi\Contracts\Queue\Queue as QueueContract;
use Kasi\Database\Connection;
use Kasi\Queue\Jobs\DatabaseJob;
use Kasi\Queue\Jobs\DatabaseJobRecord;
...
class DatabaseQueue extends Queue implements QueueContract, ClearableQueue
{
     ...
     *
     * @param  \Kasi\Database\Connection  $database
     * @param  string  $table
     ...
     *
     * @param  string  $queue
     * @param  \Kasi\Queue\Jobs\DatabaseJobRecord  $job
     * @param  int  $delay
     * @return mixed
     */
     ...
     *
     * @param  string|null  $queue
     * @return \Kasi\Queue\Jobs\DatabaseJobRecord|null
     */
     ...
     * @param  string  $queue
     * @param  \Kasi\Queue\Jobs\DatabaseJobRecord  $job
     * @return \Kasi\Queue\Jobs\DatabaseJob
     */
     ...
     *
     * @param  \Kasi\Queue\Jobs\DatabaseJobRecord  $job
     * @return \Kasi\Queue\Jobs\DatabaseJobRecord
     */
     ...
     *
     * @param  string  $queue
     * @param  \Kasi\Queue\Jobs\DatabaseJob  $job
     * @param  int  $delay
     * @return void
     */
