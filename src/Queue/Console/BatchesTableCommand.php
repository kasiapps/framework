...
use Kasi\Console\MigrationGeneratorCommand;
...
class BatchesTableCommand extends MigrationGeneratorCommand
{
    ...
    {
        return $this->kasi['config']['queue.batching.table'] ?? 'job_batches';
    }
    ...
    protected function migrationExists($table)
    {
        ...
        foreach ([
            ...
            join_paths($this->kasi->databasePath('migrations'), '0001_01_01_000002_create_jobs_table.php'),
        ] as $path) {
