...
use Kasi\Queue\Listener;
use Kasi\Queue\ListenerOptions;
...
class ListenCommand extends Command
{
     ...
     *
     * @param  \Kasi\Queue\Listener  $listener
     * @return void
     */
    ...
    {
        $connection = $connection ?: $this->kasi['config']['queue.default'];

        return $this->input->getOption('queue') ?: $this->kasi['config']->get(
     ...
     *
     * @return \Kasi\Queue\ListenerOptions
     */
