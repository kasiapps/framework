...
use Kasi\Auth\Events\Attempting;
use Kasi\Auth\Events\Authenticated;
use Kasi\Auth\Events\CurrentDeviceLogout;
use Kasi\Auth\Events\Failed;
use Kasi\Auth\Events\Login;
use Kasi\Auth\Events\Logout;
use Kasi\Auth\Events\OtherDeviceLogout;
use Kasi\Auth\Events\Validated;
use Kasi\Contracts\Auth\Authenticatable as AuthenticatableContract;
use Kasi\Contracts\Auth\StatefulGuard;
use Kasi\Contracts\Auth\SupportsBasicAuth;
use Kasi\Contracts\Auth\UserProvider;
use Kasi\Contracts\Cookie\QueueingFactory as CookieJar;
use Kasi\Contracts\Events\Dispatcher;
use Kasi\Contracts\Session\Session;
use Kasi\Support\Arr;
use Kasi\Support\Facades\Hash;
...
class SessionGuard implements StatefulGuard, SupportsBasicAuth
{
     ...
     *
     * @var \Kasi\Contracts\Session\Session
     */
    protected $session;

    /**
     * The Kasi cookie creator service.
     *
     * @var \Kasi\Contracts\Cookie\QueueingFactory
     */
    protected $cookie;
     ...
     * @param  \Kasi\Contracts\Session\Session  $session
     * @param  \Symfony\Component\HttpFoundation\Request|null  $request
     * @param  \Kasi\Support\Timebox|null  $timebox
     ...
     *
     * @param  \Kasi\Auth\Recaller  $recaller
     * @return mixed
     */
     ...
     *
     * @return \Kasi\Auth\Recaller|null
     */
     ...
     *
     * @param  mixed  $id
     * @return \Kasi\Contracts\Auth\Authenticatable|false
     */
     ...
     *
     * @param  \Kasi\Contracts\Auth\Authenticatable|null  $user
     * @param  array  $credentials
     * @return void
     */
     ...
     *
     * @return \Kasi\Contracts\Cookie\QueueingFactory
     *
     ...
     *
     * @param  \Kasi\Contracts\Cookie\QueueingFactory  $cookie
     * @return void
     */
     ...
     *
     * @return \Kasi\Contracts\Session\Session
     */
