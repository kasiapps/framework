...
use Closure;
use Kasi\Contracts\Auth\Factory as FactoryContract;
use InvalidArgumentException;

/**
 * @mixin \Kasi\Contracts\Auth\Guard
 * @mixin \Kasi\Contracts\Auth\StatefulGuard
 */
