...
namespace Kasi\Redis;

use Closure;
use Kasi\Contracts\Redis\Factory;
use Kasi\Redis\Connections\Connection;
use Kasi\Redis\Connectors\PhpRedisConnector;
use Kasi\Redis\Connectors\PredisConnector;
use Kasi\Support\Arr;
use Kasi\Support\ConfigurationUrlParser;
use InvalidArgumentException;

/**
 * @mixin \Kasi\Redis\Connections\Connection
 */
class RedisManager implements Factory
{
     ...
     *
     * @param  \Kasi\Redis\Connections\Connection  $connection
     * @param  string  $name
     * @return \Kasi\Redis\Connections\Connection
     */
     ...
     *
     * @return \Kasi\Contracts\Redis\Connector|null
     */
