...
namespace Kasi\Redis\Limiters;

use Kasi\Contracts\Redis\LimiterTimeoutException;
...
class DurationLimiterBuilder
{
     ...
     *
     * @var \Kasi\Redis\Connections\Connection
     */
    public $connection;
     ...
     * @return mixed
     *
     * @throws \Kasi\Contracts\Redis\LimiterTimeoutException
     */
