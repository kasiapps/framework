...
namespace Kasi\Redis\Connections;

use Closure;
use Kasi\Contracts\Events\Dispatcher;
use Kasi\Redis\Events\CommandExecuted;
use Kasi\Redis\Limiters\ConcurrencyLimiterBuilder;
use Kasi\Redis\Limiters\DurationLimiterBuilder;
...
abstract class Connection
{
     ...
     *
     * @param  string  $name
     * @return \Kasi\Redis\Limiters\ConcurrencyLimiterBuilder
     */
     ...
     *
     * @param  string  $name
     * @return \Kasi\Redis\Limiters\DurationLimiterBuilder
     */
