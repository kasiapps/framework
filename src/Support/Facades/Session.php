 ...
 * @method static \Kasi\Session\SessionManager extend(string $driver, \Closure $callback)
 * @method static array getDrivers()
 * @method static \Kasi\Contracts\Container\Container getContainer()
 * @method static \Kasi\Session\SessionManager setContainer(\Kasi\Contracts\Container\Container $container)
 * @method static \Kasi\Session\SessionManager forgetDrivers()
 ...
 * @method static \Kasi\Support\Uri previousUri()
 ...
 * @method static void setRequestOnHandler(\Kasi\Http\Request $request)
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 *
 * @see \Kasi\Session\SessionManager
 */
