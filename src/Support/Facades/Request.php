...
/**
 * @method static \Kasi\Http\Request capture()
 * @method static \Kasi\Http\Request instance()
 * @method static string method()
 * @method static \Kasi\Support\Uri uri()
 ...
 * @method static \Kasi\Http\Request merge(array $input)
 * @method static \Kasi\Http\Request mergeIfMissing(array $input)
 * @method static \Kasi\Http\Request replace(array $input)
 * @method static mixed get(string $key, mixed $default = null)
 * @method static \Symfony\Component\HttpFoundation\InputBag|mixed json(string|null $key = null, mixed $default = null)
 * @method static \Kasi\Http\Request createFrom(\Kasi\Http\Request $from, \Kasi\Http\Request|null $to = null)
 * @method static \Kasi\Http\Request createFromBase(\Symfony\Component\HttpFoundation\Request $request)
 * @method static \Kasi\Http\Request duplicate(array|null $query = null, array|null $request = null, array|null $attributes = null, array|null $cookies = null, array|null $files = null, array|null $server = null)
 ...
 * @method static \Kasi\Contracts\Session\Session session()
 * @method static void setKasiSession(\Kasi\Contracts\Session\Session $session)
 * @method static void setRequestLocale(string $locale)
 * @method static void setDefaultRequestLocale(string $locale)
 * @method static mixed user(string|null $guard = null)
 * @method static \Kasi\Routing\Route|object|string|null route(string|null $param = null, mixed $default = null)
 * @method static string fingerprint()
 * @method static \Kasi\Http\Request setJson(\Symfony\Component\HttpFoundation\InputBag $json)
 * @method static \Closure getUserResolver()
 * @method static \Kasi\Http\Request setUserResolver(\Closure $callback)
 * @method static \Closure getRouteResolver()
 * @method static \Kasi\Http\Request setRouteResolver(\Closure $callback)
 ...
 * @method static \Kasi\Http\Request createFromGlobals()
 * @method static \Kasi\Http\Request create(string $uri, string $method = 'GET', array $parameters = [], array $cookies = [], array $files = [], array $server = [], string|resource|null $content = null)
 ...
 * @method static string|array|null old(string|null $key = null, \Kasi\Database\Eloquent\Model|string|array|null $default = null)
 ...
 * @method static \Kasi\Support\Fluent fluent(array|string|null $key = null)
 ...
 * @method static \Kasi\Http\UploadedFile|\Kasi\Http\UploadedFile[]|array|null file(string|null $key = null, mixed $default = null)
 * @method static \Kasi\Http\Request dump(mixed $keys = [])
 * @method static never dd(mixed ...$args)
 * @method static bool exists(string|array $key)
 * @method static bool has(string|array $key)
 * @method static bool hasAny(string|array $keys)
 * @method static \Kasi\Http\Request|mixed whenHas(string $key, callable $callback, callable|null $default = null)
 ...
 * @method static \Kasi\Http\Request|mixed whenFilled(string $key, callable $callback, callable|null $default = null)
 * @method static bool missing(string|array $key)
 * @method static \Kasi\Http\Request|mixed whenMissing(string $key, callable $callback, callable|null $default = null)
 * @method static \Kasi\Support\Stringable str(string $key, mixed $default = null)
 * @method static \Kasi\Support\Stringable string(string $key, mixed $default = null)
 ...
 * @method static \Kasi\Support\Carbon|null date(string $key, string|null $format = null, string|null $tz = null)
 ...
 * @method static \Kasi\Support\Collection collect(array|string|null $key = null)
 * @method static array only(array|mixed $keys)
 * @method static array except(array|mixed $keys)
 * @method static \Kasi\Http\Request|mixed when(\Closure|mixed|null $value = null, callable|null $callback = null, callable|null $default = null)
 * @method static \Kasi\Http\Request|mixed unless(\Closure|mixed|null $value = null, callable|null $callback = null, callable|null $default = null)
