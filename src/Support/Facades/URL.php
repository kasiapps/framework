 ...
 * @method static bool hasValidSignature(\Kasi\Http\Request $request, bool $absolute = true, array $ignoreQuery = [])
 * @method static bool hasValidRelativeSignature(\Kasi\Http\Request $request, array $ignoreQuery = [])
 * @method static bool hasCorrectSignature(\Kasi\Http\Request $request, bool $absolute = true, array $ignoreQuery = [])
 * @method static bool signatureHasNotExpired(\Kasi\Http\Request $request)
 * @method static string route(\BackedEnum|string $name, mixed $parameters = [], bool $absolute = true)
 * @method static string toRoute(\Kasi\Routing\Route $route, mixed $parameters, bool $absolute)
 ...
 * @method static string format(string $root, string $path, \Kasi\Routing\Route|null $route = null)
 ...
 * @method static \Kasi\Routing\UrlGenerator formatHostUsing(\Closure $callback)
 * @method static \Kasi\Routing\UrlGenerator formatPathUsing(\Closure $callback)
 * @method static \Closure pathFormatter()
 * @method static \Kasi\Http\Request getRequest()
 * @method static void setRequest(\Kasi\Http\Request $request)
 * @method static \Kasi\Routing\UrlGenerator setRoutes(\Kasi\Routing\RouteCollectionInterface $routes)
 * @method static \Kasi\Routing\UrlGenerator setSessionResolver(callable $sessionResolver)
 * @method static \Kasi\Routing\UrlGenerator setKeyResolver(callable $keyResolver)
 * @method static \Kasi\Routing\UrlGenerator withKeyResolver(callable $keyResolver)
 * @method static \Kasi\Routing\UrlGenerator resolveMissingNamedRoutesUsing(callable $missingNamedRouteResolver)
 * @method static string getRootControllerNamespace()
 * @method static \Kasi\Routing\UrlGenerator setRootControllerNamespace(string $rootNamespace)
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 *
 * @see \Kasi\Routing\UrlGenerator
 */
