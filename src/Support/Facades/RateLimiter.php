...
/**
 * @method static \Kasi\Cache\RateLimiter for(\BackedEnum|\UnitEnum|string $name, \Closure $callback)
...
class RateLimiter extends Facade
{
    ...
    {
        return \Kasi\Cache\RateLimiter::class;
    }
}
