 ...
 * @method static \Kasi\Database\Connection getConnection()
 * @method static \Kasi\Database\Schema\Builder setConnection(\Kasi\Database\Connection $connection)
 ...
 *
 * @see \Kasi\Database\Schema\Builder
 */
