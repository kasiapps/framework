 ...
 * @method static \Kasi\Contracts\Queue\Queue connection(string|null $name = null)
 ...
 * @method static \Kasi\Queue\QueueManager setApplication(\Kasi\Contracts\Foundation\Application $app)
 ...
 * @method static \Kasi\Contracts\Queue\Job|null pop(string|null $queue = null)
 * @method static string getConnectionName()
 * @method static \Kasi\Contracts\Queue\Queue setConnectionName(string $name)
 ...
 * @method static \Kasi\Container\Container getContainer()
 * @method static void setContainer(\Kasi\Container\Container $container)
 * @method static \Kasi\Support\Testing\Fakes\QueueFake except(array|string $jobsToBeQueued)
 ...
 * @method static \Kasi\Support\Collection pushed(string $job, callable|null $callback = null)
 * @method static \Kasi\Support\Collection pushedRaw(null|\Closure $callback = null)
 ...
 * @method static \Kasi\Support\Testing\Fakes\QueueFake serializeAndRestore(bool $serializeAndRestore = true)
 *
 * @see \Kasi\Queue\QueueManager
 * @see \Kasi\Queue\Queue
 * @see \Kasi\Support\Testing\Fakes\QueueFake
 */
class Queue extends Facade
{
     ...
     * @return \Kasi\Support\Testing\Fakes\QueueFake
     */
