...
/**
 * @method static void listen(\Kasi\Events\QueuedClosure|callable|array|string $events, \Kasi\Events\QueuedClosure|callable|array|string|null $listener = null)
 ...
 * @method static \Kasi\Events\Dispatcher setQueueResolver(callable $resolver)
 * @method static \Kasi\Events\Dispatcher setTransactionManagerResolver(callable $resolver)
 * @method static array getRawListeners()
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 * @method static \Kasi\Support\Testing\Fakes\EventFake except(array|string $eventsToDispatch)
 ...
 * @method static \Kasi\Support\Collection dispatched(string $event, callable|null $callback = null)
 * @method static bool hasDispatched(string $event)
 * @method static array dispatchedEvents()
 *
 * @see \Kasi\Events\Dispatcher
 * @see \Kasi\Support\Testing\Fakes\EventFake
 */
class Event extends Facade
{
     ...
     * @return \Kasi\Support\Testing\Fakes\EventFake
     */
