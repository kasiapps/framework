...
/**
 * @method static \Kasi\Foundation\Configuration\ApplicationBuilder configure(string|null $basePath = null)
 ...
 * @method static \Kasi\Foundation\Application setBasePath(string $basePath)
 * @method static string path(string $path = '')
 * @method static \Kasi\Foundation\Application useAppPath(string $path)
 * @method static string basePath(string $path = '')
 * @method static string bootstrapPath(string $path = '')
 * @method static string getBootstrapProvidersPath()
 * @method static \Kasi\Foundation\Application useBootstrapPath(string $path)
 * @method static string configPath(string $path = '')
 * @method static \Kasi\Foundation\Application useConfigPath(string $path)
 * @method static string databasePath(string $path = '')
 * @method static \Kasi\Foundation\Application useDatabasePath(string $path)
 * @method static string langPath(string $path = '')
 * @method static \Kasi\Foundation\Application useLangPath(string $path)
 * @method static string publicPath(string $path = '')
 * @method static \Kasi\Foundation\Application usePublicPath(string $path)
 * @method static string storagePath(string $path = '')
 * @method static \Kasi\Foundation\Application useStoragePath(string $path)
 * @method static string resourcePath(string $path = '')
 * @method static string viewPath(string $path = '')
 * @method static string joinPaths(string $basePath, string $path = '')
 * @method static string environmentPath()
 * @method static \Kasi\Foundation\Application useEnvironmentPath(string $path)
 * @method static \Kasi\Foundation\Application loadEnvironmentFrom(string $file)
 ...
 * @method static \Kasi\Support\ServiceProvider register(\Kasi\Support\ServiceProvider|string $provider, bool $force = false)
 * @method static \Kasi\Support\ServiceProvider|null getProvider(\Kasi\Support\ServiceProvider|string $provider)
 * @method static array getProviders(\Kasi\Support\ServiceProvider|string $provider)
 * @method static \Kasi\Support\ServiceProvider resolveProvider(string $provider)
 ...
 * @method static void handleRequest(\Kasi\Http\Request $request)
 ...
 * @method static \Kasi\Foundation\Application dontMergeFrameworkConfiguration()
 ...
 * @method static \Kasi\Foundation\Application addAbsoluteCachePathPrefix(string $prefix)
 * @method static \Kasi\Contracts\Foundation\MaintenanceMode maintenanceMode()
 * @method static bool isDownForMaintenance()
 * @method static never abort(int $code, string $message = '', array $headers = [])
 * @method static \Kasi\Foundation\Application terminating(callable|string $callback)
 ...
 * @method static \Kasi\Contracts\Container\ContextualBindingBuilder when(array|string $concrete)
 ...
 * @method static \Kasi\Foundation\Application getInstance()
 * @method static \Kasi\Contracts\Container\Container|\Kasi\Foundation\Application setInstance(\Kasi\Contracts\Container\Container|null $container = null)
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 *
 * @see \Kasi\Foundation\Application
 */
