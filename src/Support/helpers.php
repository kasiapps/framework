...
use Kasi\Support\HigherOrderTapProxy;
use Kasi\Support\Once;
use Kasi\Support\Onceable;
use Kasi\Support\Optional;
...
if (! function_exists('e')) {
     ...
     *
     * @param  \Kasi\Contracts\Support\DeferringDisplayableValue|\Kasi\Contracts\Support\Htmlable|\BackedEnum|string|int|float|null  $value
...
if (! function_exists('kasi_cloud')) {
    /**
     * Determine if the application is running on Kasi Cloud.
     *
     * @return bool
     */
    function kasi_cloud()
    {
        return ($_ENV['KASI_CLOUD'] ?? false) === '1' ||
               ($_SERVER['KASI_CLOUD'] ?? false) === '1';
    }
}
...
if (! function_exists('optional')) {
     ...
     * @return ($callback is null ? \Kasi\Support\Optional : ($value is null ? null : TReturn))
     */
...
if (! function_exists('str')) {
     ...
     * @return ($string is null ? object : \Kasi\Support\Stringable)
     */
...
if (! function_exists('tap')) {
     ...
     * @return ($callback is null ? \Kasi\Support\HigherOrderTapProxy : TValue)
     */
