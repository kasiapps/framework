...
use Closure;
use Kasi\Contracts\Mail\Factory;
use Kasi\Contracts\Mail\Mailable;
use Kasi\Contracts\Mail\Mailer;
use Kasi\Contracts\Mail\MailQueue;
...
class MailFake implements Factory, Fake, Mailer, MailQueue
{
     ...
     *
     * @param  \Kasi\Contracts\Mail\Mailable|string|array  $view
     * @param  array  $data
     ...
     *
     * @param  \Kasi\Contracts\Mail\Mailable|string|array  $mailable
     * @param  array  $data
     * @param  \Closure|string|null  $callback
     * @return void
     */
