...
use Closure;
use Exception;
use Kasi\Contracts\Notifications\Dispatcher as NotificationDispatcher;
use Kasi\Contracts\Notifications\Factory as NotificationFactory;
...
class NotificationFake implements Fake, NotificationDispatcher, NotificationFactory
{
     ...
     *
     * @param  \Kasi\Support\Collection|array|mixed  $notifiables
