 ...
 *
 * @method \Kasi\Support\Carbon create($year = 0, $month = 1, $day = 1, $hour = 0, $minute = 0, $second = 0, $tz = null)
 * @method \Kasi\Support\Carbon createFromDate($year = null, $month = null, $day = null, $tz = null)
 * @method \Kasi\Support\Carbon|false createFromFormat($format, $time, $tz = null)
 * @method \Kasi\Support\Carbon createFromTime($hour = 0, $minute = 0, $second = 0, $tz = null)
 * @method \Kasi\Support\Carbon createFromTimeString($time, $tz = null)
 * @method \Kasi\Support\Carbon createFromTimestamp($timestamp, $tz = null)
 * @method \Kasi\Support\Carbon createFromTimestampMs($timestamp, $tz = null)
 * @method \Kasi\Support\Carbon createFromTimestampUTC($timestamp)
 * @method \Kasi\Support\Carbon createMidnightDate($year = null, $month = null, $day = null, $tz = null)
 * @method \Kasi\Support\Carbon|false createSafe($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $tz = null)
 ...
 * @method \Kasi\Support\Carbon fromSerialized($value)
 ...
 * @method \Kasi\Support\Carbon|null getTestNow()
 ...
 * @method \Kasi\Support\Carbon instance($date)
 ...
 * @method \Kasi\Support\Carbon|null make($var)
 * @method \Kasi\Support\Carbon maxValue()
 * @method \Kasi\Support\Carbon minValue()
 * @method void mixin($mixin)
 * @method \Kasi\Support\Carbon now($tz = null)
 * @method \Kasi\Support\Carbon parse($time = null, $tz = null)
 ...
 * @method \Kasi\Support\Carbon today($tz = null)
 * @method \Kasi\Support\Carbon tomorrow($tz = null)
 ...
 * @method \Kasi\Support\Carbon yesterday($tz = null)
 */
class DateFactory
{
    /**
