...
use Kasi\Support\Traits\EnumeratesValues;
 ...
 * @implements \Kasi\Support\Enumerable<TKey, TValue>
 */
class Collection implements ArrayAccess, CanBeEscapedWhenCastToString, Enumerable
{
    /**
     * @use \Kasi\Support\Traits\EnumeratesValues<TKey, TValue>
     */
     ...
     *
     * @param  \Kasi\Contracts\Support\Arrayable<TKey, TValue>|iterable<TKey, TValue>|null  $items
     * @return void
     */
     ...
     *
     * @return \Kasi\Support\LazyCollection<TKey, TValue>
     */
     ...
     *
     * @param  \Kasi\Contracts\Support\Arrayable<TCrossJoinKey, TCrossJoinValue>|iterable<TCrossJoinKey, TCrossJoinValue>  ...$lists
     ...
     *
     * @param  \Kasi\Contracts\Support\Arrayable<array-key, TValue>|iterable<array-key, TValue>  $items
     * @return static
     */
     ...
     *
     * @param  \Kasi\Contracts\Support\Arrayable<TKey, TValue>|iterable<TKey, TValue>  $items
     * @return static
     */
     ...
     *
     * @param  \Kasi\Contracts\Support\Arrayable<TKey, mixed>|iterable<TKey, mixed>  $items
     * @return static
     */
     ...
     *
     * @param  \Kasi\Support\Enumerable<array-key, TKey>|array<array-key, TKey>|string  $keys
     * @return static
     */
     ...
     *
     * \Kasi\Contracts\Support\Arrayable<array-key, TValue>|iterable<array-key, TKey>|TKey  $keys
     *
     * @return $this
     */
     ...
     *
     * @param  \Kasi\Contracts\Support\Arrayable<TKey, TMergeRecursiveValue>|iterable<TKey, TMergeRecursiveValue>  $items
     ...
     *
     * @param  \Kasi\Contracts\Support\Arrayable<array-key, TCombineValue>|iterable<array-key, TCombineValue>  $values
     ...
     *
     * @param  \Kasi\Support\Enumerable<array-key, TKey>|array<array-key, TKey>|string|null  $keys
     * @return static
     */
     ...
     * @return TValue
     *
     * @throws \Kasi\Support\ItemNotFoundException
     * @throws \Kasi\Support\MultipleItemsFoundException
     */
     ...
     * @template TZipValue
     *
     * @param  \Kasi\Contracts\Support\Arrayable<array-key, TZipValue>|iterable<array-key, TZipValue>  ...$items
     ...
     *
     * @return \Kasi\Support\Collection<TKey, TValue>
     */
