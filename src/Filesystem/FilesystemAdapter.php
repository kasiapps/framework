...
namespace Kasi\Filesystem;

use Closure;
use Kasi\Container\Container;
use Kasi\Contracts\Debug\ExceptionHandler;
use Kasi\Contracts\Filesystem\Cloud as CloudFilesystemContract;
use Kasi\Contracts\Filesystem\Filesystem as FilesystemContract;
use Kasi\Http\File;
...
class FilesystemAdapter implements CloudFilesystemContract
{
     ...
     *
     * @param  string  $path
     * @param  \Psr\Http\Message\StreamInterface|\Kasi\Http\File|\Kasi\Http\UploadedFile|string|resource  $contents
     * @param  mixed  $options
     * @return string|bool
     */
     ...
     *
     * @param  \Kasi\Http\File|\Kasi\Http\UploadedFile|string  $path
     * @param  \Kasi\Http\File|\Kasi\Http\UploadedFile|string|array|null  $file
     * @param  mixed  $options
     * @return string|false
     */
