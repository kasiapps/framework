...
trait BuildsQueries
{
     ...
     *
     * @param  int  $count
     * @param  callable(\Kasi\Support\Collection<int, TValue>, int): mixed  $callback
     * @return bool
     */
     ...
     * @param  int  $count
     * @return \Kasi\Support\Collection<int, TReturn>
     */
     ...
     *
     * @param  int  $chunkSize
     * @return \Kasi\Support\LazyCollection<int, TValue>
     *
     ...
     * @param  string|null  $alias
     * @param  bool  $descending
     * @return \Kasi\Support\LazyCollection
     *
     * @throws \InvalidArgumentException
     */
     ...
     * @return TValue
     *
     * @throws \Kasi\Database\RecordNotFoundException
     */
     ...
     *
     * @param  \Kasi\Database\Query\Builder|\Kasi\Database\Eloquent\Builder<*>  $builder
     ...
     * @param  int  $currentPage
     * @param  array  $options
     * @return \Kasi\Pagination\Paginator
     */
     ...
     * @param  \Kasi\Support\Collection  $items
     * @param  int  $perPage
     * @param  \Kasi\Pagination\Cursor  $cursor
     * @param  array  $options
     * @return \Kasi\Pagination\CursorPaginator
     */
