...
namespace Kasi\Database\Migrations;

use Closure;
use Kasi\Console\View\Components\BulletList;
use Kasi\Console\View\Components\Info;
use Kasi\Console\View\Components\Task;
use Kasi\Console\View\Components\TwoColumnDetail;
use Kasi\Contracts\Events\Dispatcher;
use Kasi\Database\ConnectionResolverInterface as Resolver;
use Kasi\Database\Events\MigrationEnded;
use Kasi\Database\Events\MigrationsEnded;
use Kasi\Database\Events\MigrationsStarted;
use Kasi\Database\Events\MigrationStarted;
use Kasi\Database\Events\NoPendingMigrations;
...
class Migrator
{
     ...
     *
     * @var array<string, \Kasi\Database\Migrations\Migration|null>
     */
     ...
     *
     * @return \Kasi\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @return \Kasi\Filesystem\Filesystem
     */
     ...
     *
     * @param  \Kasi\Contracts\Database\Events\MigrationEvent  $event
     * @return void
     */
