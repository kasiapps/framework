...
use Kasi\Database\Events\StatementPrepared;
use Kasi\Database\Events\TransactionBeginning;
use Kasi\Database\Events\TransactionCommitted;
use Kasi\Database\Events\TransactionCommitting;
use Kasi\Database\Events\TransactionRolledBack;
use Kasi\Database\Query\Builder as QueryBuilder;
use Kasi\Database\Query\Expression;
use Kasi\Database\Query\Grammars\Grammar as QueryGrammar;
use Kasi\Database\Query\Processors\Processor;
use Kasi\Database\Schema\Builder as SchemaBuilder;
...
class Connection implements ConnectionInterface
{
     ...
     *
     * @var \Kasi\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @var \Kasi\Database\DatabaseTransactionsManager|null
     */
     ...
     *
     * @return \Kasi\Database\Schema\Grammars\Grammar|null
     */
     ...
     *
     * @param  \Closure|\Kasi\Database\Query\Builder|\Kasi\Contracts\Database\Query\Expression|string  $table
     ...
     * @return mixed
     *
     * @throws \Kasi\Database\MultipleColumnsSelectedException
     */
     ...
     * @return mixed
     *
     * @throws \Kasi\Database\QueryException
     */
     ...
     *
     * @param  \Kasi\Database\QueryException  $e
     * @param  string  $query
     * @param  array  $bindings
     * @param  \Closure  $callback
     * @return mixed
     ...
     * @return mixed|false
     *
     * @throws \Kasi\Database\LostConnectionException
     */
     ...
     *
     * @param  \Kasi\Database\Query\Grammars\Grammar  $grammar
     * @return $this
     */
     ...
     *
     * @return \Kasi\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @param  \Kasi\Database\Schema\Grammars\Grammar  $grammar
     * @return $this
     */
     ...
     *
     * @param  \Kasi\Database\Query\Processors\Processor  $processor
     * @return $this
     */
     ...
     *
     * @param  \Kasi\Database\DatabaseTransactionsManager  $manager
     * @return $this
     */
     ...
     *
     * @template TGrammar of \Kasi\Database\Grammar
     *
