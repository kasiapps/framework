...
use Kasi\Database\Schema\IndexDefinition;
...
class SQLiteGrammar extends Grammar
{
     ...
     *
     * @param  \Kasi\Database\Schema\ForeignKeyDefinition[]  $foreignKeys
     * @return string|null
     */
     ...
     *
     * @param  \Kasi\Support\Fluent  $foreign
     * @return string
     */
     ...
     *
     * @param  \Kasi\Support\Fluent|null  $primary
     * @return string|null
     */
