...
abstract class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \Kasi\Database\Schema\Blueprint  $blueprint
     * @param  \Kasi\Database\Schema\ColumnDefinition  $column
     * @return string
     */
     ...
     * @param  \Kasi\Database\Schema\Blueprint  $blueprint
     * @param  string  $name
     * @return \Kasi\Support\Fluent|null
     */
     ...
     *
     * @param  \Kasi\Support\Fluent|\Kasi\Contracts\Database\Query\Expression|string  $value
     * @return string
     */
