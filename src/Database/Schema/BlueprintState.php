...
class BlueprintState
{
     ...
     *
     * @var \Kasi\Database\Schema\Blueprint
     */
    protected $blueprint;
     ...
     * The primary key.
     *
     * @var \Kasi\Database\Schema\IndexDefinition|null
     */
    private $primaryKey;
     ...
     * The indexes.
     *
     * @var \Kasi\Database\Schema\IndexDefinition[]
     */
    private $indexes;
     ...
     * The foreign keys.
     *
     * @var \Kasi\Database\Schema\ForeignKeyDefinition[]
     */
    private $foreignKeys;
     ...
     * Get the primary key.
     *
     * @return \Kasi\Database\Schema\IndexDefinition|null
     */
