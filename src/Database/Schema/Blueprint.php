...
use Kasi\Database\Schema\Grammars\Grammar;
use Kasi\Database\Schema\Grammars\MySqlGrammar;
...
class Blueprint
{
     ...
     *
     * @var \Kasi\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     *
     * @var \Kasi\Database\Schema\BlueprintState|null
     */
    protected $state;
     ...
     *
     * @deprecated Will be removed in a future Kasi version.
     *
     * @param  array  $names
     ...
     * Indicate that the given foreign key should be dropped.
     *
     * @param  \Kasi\Database\Eloquent\Model|string  $model
     ...
     * @return \Kasi\Database\Schema\IndexDefinition
     */
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \Kasi\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Kasi\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Kasi\Database\Schema\ForeignIdColumnDefinition
     */
     ...
     *
     * @param  \Kasi\Database\Schema\ColumnDefinition  $definition
     * @return \Kasi\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @return \Kasi\Database\Schema\BlueprintState
     */
