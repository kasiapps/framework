...
class MigrateMakeCommand extends BaseCommand implements PromptsForMissingInput
{
     ...
     *
     * @var \Kasi\Database\Migrations\MigrationCreator
     */
    protected $creator;
     ...
     *
     * @param  \Kasi\Database\Migrations\MigrationCreator  $creator
     * @param  \Kasi\Support\Composer  $composer
     * @return void
     */
