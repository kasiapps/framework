...
use Kasi\Console\ConfirmableTrait;
use Kasi\Contracts\Console\Isolatable;
use Kasi\Contracts\Events\Dispatcher;
use Kasi\Database\Events\SchemaLoaded;
use Kasi\Database\Migrations\Migrator;
use Kasi\Database\SQLiteDatabaseDoesNotExistException;
use Kasi\Database\SqlServerConnection;
...
use function Kasi\Prompts\confirm;
...
class MigrateCommand extends BaseCommand implements Isolatable
{
     ...
     *
     * @var \Kasi\Database\Migrations\Migrator
     */
    protected $migrator;
     ...
     *
     * @param  \Kasi\Database\Migrations\Migrator  $migrator
    ...
    {
        if ($this->kasi['config']->get("database.connections.{$connection->getName()}.database") !== $connection->getDatabaseName()) {
            return false;
        }
        ...
        try {
            ...
            $this->kasi['config']->set("database.connections.{$connection->getName()}.database", $connection->getDatabaseName());
        }
    }
