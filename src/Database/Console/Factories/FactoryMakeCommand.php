...
namespace Kasi\Database\Console\Factories;
...
class FactoryMakeCommand extends GeneratorCommand
{
    ...
    {
        return file_exists($customPath = $this->kasi->basePath(trim($stub, '/')))
            ? $customPath
            : __DIR__.$stub;
    }
    ...
    protected function getPath($name)
    {
        ...
        return $this->kasi->databasePath().'/factories/'.str_replace('\\', '/', $name).'.php';
    }
