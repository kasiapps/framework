...
use Kasi\Database\Concerns\CompilesJsonPaths;
use Kasi\Database\Grammar as BaseGrammar;
...
class Grammar extends BaseGrammar
{
    ...
    protected function compileGroupLimit(Builder $query)
    {
        ...
        $table = $this->wrap('kasi_table');
        $row = $this->wrap('kasi_row');
    ...
    protected function compileRowNumber($partition, $orders)
    {
        ...
        return ', row_number() over ('.$over.') as '.$this->wrap('kasi_row');
    }
