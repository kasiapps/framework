...
use Kasi\Contracts\Database\Query\Builder as BuilderContract;
use Kasi\Contracts\Database\Query\ConditionExpression;
...
use Kasi\Database\Concerns\BuildsWhereDateClauses;
use Kasi\Database\Concerns\ExplainsQueries;
...
{
    /** @use \Kasi\Database\Concerns\BuildsQueries<object> */
     ...
     *
     * @var \Kasi\Database\ConnectionInterface
     */
    public $connection;
     ...
     *
     * @var \Kasi\Database\Query\Grammars\Grammar
     */
    public $grammar;
     ...
     *
     * @var \Kasi\Database\Query\Processors\Processor
     */
    public $processor;
     ...
     *
     * @var \Kasi\Database\Query\Expression|string
     */
    public $from;
     ...
     *
     * @var \Kasi\Database\Query\IndexHint|null
     */
    public $indexHint;
     ...
     *
     * @param  \Closure|\Kasi\Database\Query\Builder|\Kasi\Database\Eloquent\Builder<*>|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \Closure|\Kasi\Database\Query\Builder|\Kasi\Database\Eloquent\Builder<*>|\Kasi\Contracts\Database\Query\Expression|string  $table
     ...
     *
     * @param  \Kasi\Contracts\Database\Query\Expression|string  $table
     * @param  \Closure|\Kasi\Contracts\Database\Query\Expression|string  $first
     * @param  string|null  $operator
     * @param  \Kasi\Contracts\Database\Query\Expression|string|null  $second
     * @param  string  $type
     * @param  bool  $where
     * @return $this
     */
     ...
     * @param  \Kasi\Contracts\Database\Query\Expression|string  $second
     * @param  string  $type
     * @return $this
     */
     ...
     *
     * @param  \Kasi\Contracts\Database\Query\Expression|string  $table
     * @param  \Closure|\Kasi\Contracts\Database\Query\Expression|string|null  $first
     * @param  string|null  $operator
     * @param  \Kasi\Contracts\Database\Query\Expression|string|null  $second
     * @return $this
     */
     ...
     * @param  string  $type
     * @param  \Kasi\Contracts\Database\Query\Expression|string  $table
     * @return \Kasi\Database\Query\JoinClause
     */
     ...
     * @param  string  $type
     * @param  \Kasi\Contracts\Database\Query\Expression|string  $table
     * @return \Kasi\Database\Query\JoinLateralClause
     */
     ...
     *
     * @param  \Closure|string|array|\Kasi\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  \Kasi\Contracts\Database\Query\Expression|string|array  $first
     * @param  string|null  $operator
     ...
     *
     * @param  \Kasi\Contracts\Database\Query\Expression|string  $column
     * @param  string  $value
     ...
     *
     * @param  string  $column
     * @param  \Kasi\Contracts\Support\Arrayable|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\Kasi\Contracts\Database\Query\Expression  $columns
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\Kasi\Contracts\Database\Query\Expression  $column
     * @return $this
     */
     ...
     *
     * @return \Kasi\Database\Query\Builder
     */
     ...
     *
     * @param  \Kasi\Database\Query\Builder  $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     * @param  \Kasi\Contracts\Database\Query\Expression|string  $column
     * @param  string  $operator
     * @param  \Closure|\Kasi\Database\Query\Builder|\Kasi\Database\Eloquent\Builder<*>  $callback
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \Kasi\Contracts\Database\Query\Expression[]|\Closure[]|string[]  $columns
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  array|\Kasi\Contracts\Database\Query\Expression|string  ...$groups
     * @return $this
     */
     ...
     *
     * @param  \Kasi\Contracts\Database\Query\Expression|\Closure|string  $column
     ...
     *
     * @param  \Closure|\Kasi\Database\Query\Builder|\Kasi\Database\Eloquent\Builder<*>|\Kasi\Contracts\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\Kasi\Database\Query\Builder|\Kasi\Contracts\Database\Query\Expression|string  $column
     * @return $this
     */
     ...
     *
     * @param  \Closure|\Kasi\Database\Query\Builder|\Kasi\Contracts\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     *
     * @param  \Closure|\Kasi\Database\Query\Builder|\Kasi\Database\Eloquent\Builder<*>  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     * @return mixed
     *
     * @throws \Kasi\Database\RecordsNotFoundException
     * @throws \Kasi\Database\MultipleRecordsFoundException
     */
     ...
     *
     * @param  array|string  $columns
     * @return \Kasi\Support\Collection<int, \stdClass>
     */
     ...
     *
     * @param  \Kasi\Support\Collection  $items
     * @return \Kasi\Support\Collection
     */
    protected function withoutGroupLimitKeys($items)
    {
        $keysToRemove = ['kasi_row'];

        if (is_string($this->groupLimit['column'])) {
            $column = last(explode('.', $this->groupLimit['column']));

            $keysToRemove[] = '@kasi_group := '.$this->grammar->wrap($column);
            $keysToRemove[] = '@kasi_group := '.$this->grammar->wrap('pivot_'.$column);
        }
     ...
     * @return \Kasi\Pagination\LengthAwarePaginator
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \Kasi\Contracts\Pagination\Paginator
     */
     ...
     * @param  \Kasi\Pagination\Cursor|string|null  $cursor
     * @return \Kasi\Contracts\Pagination\CursorPaginator
     */
     ...
     *
     * @return \Kasi\Support\LazyCollection<int, \stdClass>
     */
     ...
     * @return \Kasi\Support\Collection<array-key, mixed>
     */
     ...
     *
     * @param  \Kasi\Contracts\Database\Query\Expression|string  $columns
     * @return int
     */
     ...
     *
     * @param  mixed  $value
     * @return \Kasi\Contracts\Database\Query\Expression
     */
     ...
     *
     * @return \Kasi\Database\ConnectionInterface
     */
     ...
     *
     * @return \Kasi\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \Kasi\Database\Query\Grammars\Grammar
     */
