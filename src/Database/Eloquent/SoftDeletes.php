...
/**
 * @method static \Kasi\Database\Eloquent\Builder<static> withTrashed(bool $withTrashed = true)
 * @method static \Kasi\Database\Eloquent\Builder<static> onlyTrashed()
 * @method static \Kasi\Database\Eloquent\Builder<static> withoutTrashed()
...
trait SoftDeletes
{
     ...
     *
     * @param  \Kasi\Events\QueuedClosure|callable|class-string  $callback
     * @return void
     */
