...
use Kasi\Database\MultipleRecordsFoundException;
 ...
 * @template TResult
 *
 * @mixin \Kasi\Database\Eloquent\Builder<TRelatedModel>
 */
abstract class Relation implements BuilderContract
{
     ...
     *
     * @var \Kasi\Database\Eloquent\Builder<TRelatedModel>
     */
    protected $query;
     ...
     *
     * @var array<string, class-string<\Kasi\Database\Eloquent\Model>>
     */
    ...
    {
        return 'kasi_reserved_'.($incrementJoinCount ? static::$selfJoinCount++ : static::$selfJoinCount);
    }
     ...
     *
     * @param  array<string, class-string<\Kasi\Database\Eloquent\Model>>  $map
     * @param  bool  $merge
     * @return array
     */
     ...
     *
     * @param  array<string, class-string<\Kasi\Database\Eloquent\Model>>|null  $map
     * @param  bool  $merge
     * @return array<string, class-string<\Kasi\Database\Eloquent\Model>>
     */
     ...
     *
     * @param  list<class-string<\Kasi\Database\Eloquent\Model>>|null  $models
     * @return array<string, class-string<\Kasi\Database\Eloquent\Model>>|null
     */
     ...
     *
     * @param  string  $alias
     * @return class-string<\Kasi\Database\Eloquent\Model>|null
     */
     ...
     *
     * @param  class-string<\Kasi\Database\Eloquent\Model>  $className
     * @return int|string
     */
