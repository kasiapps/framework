...
use Kasi\Database\Eloquent\Relations\Concerns\InteractsWithPivotTable;
 ...
 *
 * @extends \Kasi\Database\Eloquent\Relations\Relation<TRelatedModel, TDeclaringModel, \Kasi\Database\Eloquent\Collection<int, TRelatedModel>>
 */
class BelongsToMany extends Relation
{
     ...
     *
     * @var array<string|\Kasi\Contracts\Database\Query\Expression>
     */
     ...
     *
     * @param  \Kasi\Database\Eloquent\Builder<TRelatedModel>|null  $query
     * @return $this
     */
     ...
     *
     * @param  \Kasi\Database\Eloquent\Collection<int, TRelatedModel>  $results
     ...
     *
     * @param  string|\Kasi\Contracts\Database\Query\Expression|array<string, string>  $column
     * @param  mixed  $value
     * @return $this
     *
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return ($id is (\Kasi\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \Kasi\Database\Eloquent\Collection<int, TRelatedModel> : TRelatedModel)
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return ($id is (\Kasi\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \Kasi\Database\Eloquent\Collection<int, TRelatedModel> : TRelatedModel|null)
     */
     ...
     * @return TRelatedModel
     *
     * @throws \Kasi\Database\Eloquent\ModelNotFoundException<TRelatedModel>
     ...
     * @param  array  $columns
     * @return \Kasi\Database\Eloquent\Collection<int, TRelatedModel>
     */
     ...
     *     ? \Kasi\Database\Eloquent\Collection<int, TRelatedModel>|TValue
     ...
     *
     * @param  int  $chunkSize
     * @return \Kasi\Support\LazyCollection<int, TRelatedModel>
     */
     ...
     *
     * @return \Kasi\Database\Eloquent\Builder<TRelatedModel>
     */
     ...
     *
     * @return \Kasi\Support\Collection<int, int|string>
     */
     ...
     *
     * @template TContainer of \Kasi\Support\Collection<array-key, TRelatedModel>|array<array-key, TRelatedModel>
     *
     ...
     *
     * @param  \Kasi\Database\Eloquent\Builder<TRelatedModel>  $query
     * @param  \Kasi\Database\Eloquent\Builder<TDeclaringModel>  $parentQuery
     ...
     *
     * @param  string|\Kasi\Contracts\Database\Query\Expression  $column
     * @return string|\Kasi\Contracts\Database\Query\Expression
     */
