 ...
 * @template TResult
 *
 * @extends \Kasi\Database\Eloquent\Relations\Relation<TRelatedModel, TIntermediateModel, TResult>
 */
abstract class HasOneOrManyThrough extends Relation
{
    ...
    protected function buildDictionary(EloquentCollection $results)
    {
        ...
        foreach ($results as $result) {
            $dictionary[$result->kasi_through_key][] = $result;
        }
    ...
    protected function shouldSelect(array $columns = ['*'])
    {
        ...
        return array_merge($columns, [$this->getQualifiedFirstKeyName().' as kasi_through_key']);
    }
