...
use Closure;
use Exception;
use Kasi\Contracts\Database\Eloquent\Builder as BuilderContract;
use Kasi\Contracts\Database\Query\Expression;
use Kasi\Contracts\Support\Arrayable;
use Kasi\Database\Concerns\BuildsQueries;
use Kasi\Database\Eloquent\Concerns\QueriesRelationships;
...
use Kasi\Database\RecordsNotFoundException;
 ...
 *
 * @mixin \Kasi\Database\Query\Builder
 */
class Builder implements BuilderContract
{
    /** @use \Kasi\Database\Concerns\BuildsQueries<TModel> */
     ...
     *
     * @var \Kasi\Database\Query\Builder
     */
    protected $query;
     ...
     * @param  \Kasi\Database\Eloquent\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \Kasi\Database\Eloquent\Scope|string  $scope
     * @return $this
     */
     ...
     *
     * @param  (\Closure(static): mixed)|string|array|\Kasi\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  (\Closure(static): mixed)|array|string|\Kasi\Contracts\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  string|\Kasi\Contracts\Database\Query\Expression  $column
     * @return $this
     */
     ...
     *
     * @param  array  $items
     * @return \Kasi\Database\Eloquent\Collection<int, TModel>
     */
     ...
     * @return ($id is (\Kasi\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \Kasi\Database\Eloquent\Collection<int, TModel> : TModel|null)
     */
     ...
     * @return TModel
     *
     * @throws \Kasi\Database\Eloquent\ModelNotFoundException<TModel>
     ...
     *
     * @param  \Kasi\Contracts\Support\Arrayable|array  $ids
     * @param  array|string  $columns
     * @return \Kasi\Database\Eloquent\Collection<int, TModel>
     */
     ...
     * @param  mixed  $id
     * @param  array|string  $columns
     * @return ($id is (\Kasi\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \Kasi\Database\Eloquent\Collection<int, TModel> : TModel)
     *
     * @throws \Kasi\Database\Eloquent\ModelNotFoundException<TModel>
     */
     ...
     * @return (
     *     $id is (\Kasi\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>)
     *     ? \Kasi\Database\Eloquent\Collection<int, TModel>
     *     : TModel|TValue
     * )
     */
     ...
     *
     * @param  string  $name
     * @return \Kasi\Database\Eloquent\Relations\Relation<\Kasi\Database\Eloquent\Model, TModel, *>
     */
     ...
     *
     * @return \Kasi\Support\LazyCollection<int, TModel>
     */
     ...
     *
     * @param  array<array-key, array|(\Closure(\Kasi\Database\Eloquent\Relations\Relation<*,*,*>): mixed)|string>|string  $relations
     * @param  (\Closure(\Kasi\Database\Eloquent\Relations\Relation<*,*,*>): mixed)|string|null  $callback
     * @return $this
     */
     ...
     *
     * @param  \Kasi\Contracts\Database\Query\Expression|array|string  $attributes
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @template TModelNew of \Kasi\Database\Eloquent\Model
     *
     ...
     *
     * @param  array|\Kasi\Contracts\Database\Query\Expression  $columns
     * @return array
     */
