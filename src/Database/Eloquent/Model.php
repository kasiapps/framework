...
use Kasi\Contracts\Routing\UrlRoutable;
use Kasi\Contracts\Support\Arrayable;
use Kasi\Contracts\Support\CanBeEscapedWhenCastToString;
...
use Kasi\Support\Stringable as SupportStringable;
...
abstract class Model implements Arrayable, ArrayAccess, CanBeEscapedWhenCastToString, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, Stringable, UrlRoutable
{
    use Concerns\HasAttributes,
        ...
        ForwardsCalls;
    /** @use HasCollection<\Kasi\Database\Eloquent\Collection<array-key, static & self>> */
    use HasCollection;
     ...
     *
     * @var class-string<\Kasi\Database\Eloquent\Builder<*>>
     */
     ...
     *
     * @var class-string<\Kasi\Database\Eloquent\Collection<*, *>>
     */
     ...
     * @return $this
     *
     * @throws \Kasi\Database\Eloquent\MassAssignmentException
     */
     ...
     *
     * @param  string|null  $connection
     * @return \Kasi\Database\Eloquent\Builder<static>
     */
     ...
     * @return \Kasi\Database\Eloquent\Collection<int, static>
     */
     ...
     *
     * @param  \Kasi\Database\Eloquent\Builder<static>  $query
     * @return bool
     */
     ...
     *
     * @param  \Kasi\Support\Collection|array|int|string  $ids
     * @return int
     */
     ...
     *
     * @param  \Kasi\Database\Eloquent\Builder<static>  $builder
     * @return \Kasi\Database\Eloquent\Builder<static>
     */
     ...
     * @return \Kasi\Database\Eloquent\Builder<*>
     */
     ...
     *
     * @param  \Kasi\Database\Eloquent\Model  $parent
     * @param  array  $attributes
     * @param  string  $table
     * @param  bool  $exists
     * @param  string|null  $using
     * @return \Kasi\Database\Eloquent\Relations\Pivot
     */
     ...
     * @return string
     *
     * @throws \Kasi\Database\Eloquent\JsonEncodingException
     */
     ...
     *
     * @param  \Kasi\Database\Eloquent\Model|null  $model
     * @return bool
     */
     ...
     *
     * @return \Kasi\Database\ConnectionResolverInterface|null
     */
     ...
     *
     * @param  \Kasi\Database\ConnectionResolverInterface  $resolver
     * @return void
     */
     ...
     * @return \Kasi\Database\Eloquent\Model|null
     */
     ...
     * @param  mixed  $value
     * @param  string|null  $field
     * @return \Kasi\Database\Eloquent\Relations\Relation<\Kasi\Database\Eloquent\Model, $this, *>
     */
     ...
     * Retrieve the model for a bound value.
     *
     * @param  \Kasi\Database\Eloquent\Model|\Kasi\Contracts\Database\Eloquent\Builder|\Kasi\Database\Eloquent\Relations\Relation  $query
     * @param  mixed  $value
     * @param  string|null  $field
     * @return \Kasi\Contracts\Database\Eloquent\Builder
     */
