...
use Kasi\Database\Eloquent\Casts\Json;
use Kasi\Database\Eloquent\InvalidCastException;
...
use Kasi\Database\LazyLoadingViolationException;
...
trait HasAttributes
{
     ...
     *
     * @var \Kasi\Contracts\Encryption\Encrypter|null
     */
     ...
     * @return null
     *
     * @throws \Kasi\Database\Eloquent\MissingAttributeException
     */
     ...
     *
     * @param  \Kasi\Contracts\Encryption\Encrypter|null  $encrypter
     * @return void
     */
     ...
     * @return bool
     *
     * @throws \Kasi\Database\Eloquent\InvalidCastException
     */
