...
use Closure;
use Kasi\Database\Eloquent\Attributes\ScopedBy;
use Kasi\Database\Eloquent\Scope;
...
trait HasGlobalScopes
{
     ...
     *
     * @param  \Kasi\Database\Eloquent\Scope|(\Closure(\Kasi\Database\Eloquent\Builder<static>): mixed)|string  $scope
     * @param  \Kasi\Database\Eloquent\Scope|(\Closure(\Kasi\Database\Eloquent\Builder<static>): mixed)|null  $implementation
     * @return mixed
     *
     ...
     *
     * @param  \Kasi\Database\Eloquent\Scope|string  $scope
     * @return \Kasi\Database\Eloquent\Scope|(\Closure(\Kasi\Database\Eloquent\Builder<static>): mixed)|null
     */
