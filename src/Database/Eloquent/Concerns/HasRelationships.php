...
use Closure;
use Kasi\Database\ClassMorphViolationException;
...
use Kasi\Database\Eloquent\PendingHasThroughRelationship;
...
trait HasRelationships
{
     ...
     * @return \Kasi\Database\Eloquent\Relations\HasOne<TRelatedModel, $this>
     */
     ...
     * @return \Kasi\Database\Eloquent\Relations\HasOneThrough<TRelatedModel, TIntermediateModel, $this>
     */
     ...
     * @param  string|null  $localKey
     * @return \Kasi\Database\Eloquent\Relations\MorphOne<TRelatedModel, $this>
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \Kasi\Database\Eloquent\Relations\MorphOne<TRelatedModel, TDeclaringModel>
     */
     ...
     * @return \Kasi\Database\Eloquent\Relations\BelongsTo<TRelatedModel, $this>
     */
     ...
     * @return \Kasi\Database\Eloquent\Relations\BelongsTo<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $id
     * @param  string|null  $ownerKey
     * @return \Kasi\Database\Eloquent\Relations\MorphTo<\Kasi\Database\Eloquent\Model, $this>
     */
     ...
     * @param  string  $type
     * @param  string  $relation
     * @return \Kasi\Database\Eloquent\Relations\MorphTo<TRelatedModel, TDeclaringModel>
     */
     ...
     * @template TIntermediateModel of \Kasi\Database\Eloquent\Model
     *
     * @param  string|\Kasi\Database\Eloquent\Relations\HasMany<TIntermediateModel, covariant $this>|\Kasi\Database\Eloquent\Relations\HasOne<TIntermediateModel, covariant $this>  $relationship
     * @return (
     *     $relationship is string
     *     ? \Kasi\Database\Eloquent\PendingHasThroughRelationship<\Kasi\Database\Eloquent\Model, $this>
     *     : (
     *          $relationship is \Kasi\Database\Eloquent\Relations\HasMany<TIntermediateModel, $this>
     *          ? \Kasi\Database\Eloquent\PendingHasThroughRelationship<TIntermediateModel, $this, \Kasi\Database\Eloquent\Relations\HasMany<TIntermediateModel, $this>>
     *          : \Kasi\Database\Eloquent\PendingHasThroughRelationship<TIntermediateModel, $this, \Kasi\Database\Eloquent\Relations\HasOne<TIntermediateModel, $this>>
     *     )
     * )
     */
     ...
     * @param  string|null  $foreignKey
     * @param  string|null  $localKey
     * @return \Kasi\Database\Eloquent\Relations\HasMany<TRelatedModel, $this>
     */
     ...
     * @param  string  $foreignKey
     * @param  string  $localKey
     * @return \Kasi\Database\Eloquent\Relations\HasMany<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $localKey
     * @param  string|null  $secondLocalKey
     * @return \Kasi\Database\Eloquent\Relations\HasManyThrough<TRelatedModel, TIntermediateModel, $this>
     */
     ...
     * @param  string  $localKey
     * @param  string  $secondLocalKey
     * @return \Kasi\Database\Eloquent\Relations\HasManyThrough<TRelatedModel, TIntermediateModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $id
     * @param  string|null  $localKey
     * @return \Kasi\Database\Eloquent\Relations\MorphMany<TRelatedModel, $this>
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \Kasi\Database\Eloquent\Relations\MorphMany<TRelatedModel, TDeclaringModel>
     */
     ...
     *
     * @param  class-string<TRelatedModel>  $related
     * @param  string|class-string<\Kasi\Database\Eloquent\Model>|null  $table
     * @param  string|null  $foreignPivotKey
     * @param  string|null  $relatedPivotKey
     * @param  string|null  $parentKey
     * @param  string|null  $relatedKey
     * @param  string|null  $relation
     * @return \Kasi\Database\Eloquent\Relations\BelongsToMany<TRelatedModel, $this>
     */
     ...
     * @param  \Kasi\Database\Eloquent\Builder<TRelatedModel>  $query
     * @param  TDeclaringModel  $parent
     * @param  string|class-string<\Kasi\Database\Eloquent\Model>  $table
     * @param  string  $foreignPivotKey
     * @param  string  $relatedPivotKey
     * @param  string  $parentKey
     * @param  string  $relatedKey
     * @param  string|null  $relationName
     * @return \Kasi\Database\Eloquent\Relations\BelongsToMany<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $relation
     * @param  bool  $inverse
     * @return \Kasi\Database\Eloquent\Relations\MorphToMany<TRelatedModel, $this>
     */
     ...
     * @param  string|null  $relationName
     * @param  bool  $inverse
     * @return \Kasi\Database\Eloquent\Relations\MorphToMany<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  \Kasi\Database\Eloquent\Model|null  $instance
     * @return string
     */
