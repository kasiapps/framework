...
use Exception;
use Kasi\Database\Query\Grammars\SQLiteGrammar as QueryGrammar;
use Kasi\Database\Query\Processors\SQLiteProcessor;
use Kasi\Database\Schema\Grammars\SQLiteGrammar as SchemaGrammar;
use Kasi\Database\Schema\SQLiteBuilder;
use Kasi\Database\Schema\SqliteSchemaState;
...
class SQLiteConnection extends Connection
{
     ...
     *
     * @return \Kasi\Database\Query\Grammars\SQLiteGrammar
     */
     ...
     *
     * @return \Kasi\Database\Schema\SQLiteBuilder
     */
     ...
     *
     * @return \Kasi\Database\Schema\Grammars\SQLiteGrammar
     */
     ...
     *
     * @return \Kasi\Database\Query\Processors\SQLiteProcessor
     */
