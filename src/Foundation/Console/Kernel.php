...
use Kasi\Console\Application as Artisan;
...
use Kasi\Contracts\Console\Kernel as KernelContract;
...
class Kernel implements KernelContract
{
     ...
     *
     * @var \Kasi\Foundation\Application
     */
    protected $app;
    ...
    /**
     * Re-route the Symfony command events to their Kasi counterparts.
     *
     * @internal
     *
     * @return $this
    ...
    {
        throw new RuntimeException('Queueing Artisan commands is not supported by Kasi.');
    }
     ...
     *
     * @return \Kasi\Console\Application
     */
     ...
     *
     * @return \Kasi\Contracts\Debug\ExceptionHandler
     */
