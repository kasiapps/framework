...
namespace Kasi\Foundation\Testing\Concerns;

use Kasi\Http\Request;
use Kasi\Support\Arr;
use Kasi\Support\Str;
use Kasi\Testing\Assert as PHPUnit;
...
trait MakesHttpRequests
{
     ...
     * @return \Kasi\Testing\TestResponse
     */
    public function call($method, $uri, $parameters = [], $cookies = [], $files = [], $server = [], $content = null)
    {
        ...
        $this->app['request'] = KasiRequest::createFromBase($symfonyRequest);
