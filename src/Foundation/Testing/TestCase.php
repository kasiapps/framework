...
abstract class TestCase extends BaseTestCase
{
    ...
    public function expectsEvents($events)
    {
        ...
        $mock = Mockery::spy(\Kasi\Contracts\Events\Dispatcher::class);
    ...
    {
        $mock = Mockery::mock(\Kasi\Contracts\Events\Dispatcher::class);
    ...
    protected function expectsJobs($jobs)
    {
        ...
        $mock = Mockery::mock('Kasi\Bus\Dispatcher[dispatch]', [$this->app]);
        ...
        $this->app->instance(
            \Kasi\Contracts\Bus\Dispatcher::class, $mock
        );
