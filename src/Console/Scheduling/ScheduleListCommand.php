...
class ScheduleListCommand extends Command
{
     ...
     */
    private function sortEvents(\Kasi\Support\Collection $events, DateTimeZone $timezone)
    {
     ...
     *
     * @param  \Kasi\Console\Scheduling\CallbackEvent  $event
     * @return string
     */
    private function getClosureLocation(CallbackEvent $event)
    {
        ...
        if ($callback instanceof Closure) {
            ...
            return sprintf(
                '%s:%s',
                str_replace($this->kasi->basePath().DIRECTORY_SEPARATOR, '', $function->getFileName() ?: ''),
