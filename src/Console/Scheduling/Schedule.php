...
use Kasi\Queue\CallQueuedClosure;
...
/**
 * @mixin \Kasi\Console\Scheduling\PendingEventAttributes
 */
class Schedule
{
    use Macroable {
     ...
     *
     * @var \Kasi\Console\Scheduling\EventMutex
     */
     ...
     *
     * @var \Kasi\Console\Scheduling\SchedulingMutex
     */
     ...
     *
     * @var \Kasi\Contracts\Bus\Dispatcher
     */
     ...
     *
     * @var \Kasi\Console\Scheduling\PendingEventAttributes|null
     */
    ...
    public function __construct($timezone = null)
    {
        ...
        if (! class_exists(Container::class)) {
            throw new RuntimeException(
                'A container implementation is required to use the scheduler. Please install the kasi/container package.'
            );
        }
     ...
     * @return \Kasi\Console\Scheduling\CallbackEvent
     */
     ...
     * @param  array  $parameters
     * @return \Kasi\Console\Scheduling\Event
     */
    ...
    protected function dispatchToQueue($job, $queue, $connection)
    {
        if ($job instanceof Closure) {
            if (! class_exists(CallQueuedClosure::class)) {
                throw new RuntimeException(
                    'To enable support for closure jobs, please install the kasi/queue package.'
                );
            }
     ...
     *
     * @return \Kasi\Contracts\Bus\Dispatcher
     *
     * @throws \RuntimeException
     */
    protected function getDispatcher()
    {
        if ($this->dispatcher === null) {
            try {
                ...
                throw new RuntimeException(
                    'Unable to resolve the dispatcher from the service container. Please bind it or install the kasi/bus package.',
