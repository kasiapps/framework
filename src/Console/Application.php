...
use Closure;
use Kasi\Console\Events\ArtisanStarting;
use Kasi\Contracts\Console\Application as ApplicationContract;
...
use function Kasi\Support\artisan_binary;
use function Kasi\Support\php_binary;
...
class Application extends SymfonyApplication implements ApplicationContract
{
     ...
     * @return void
     */
    public function __construct(Container $kasi, Dispatcher $events, $version)
    {
        parent::__construct('Kasi Framework', $version);
    ...
    protected function parseCommand($command, $parameters)
    {
        if (is_subclass_of($command, SymfonyCommand::class)) {
            ...
            $command = $this->kasi->make($command)->getName();
        }
     ...
     *
     * @param  \Kasi\Console\Command|string  $command
     * @return \Symfony\Component\Console\Command\Command|null
     */
    public function resolve($command)
    {
        ...
        return $this->add($this->kasi->make($command));
    }
    ...
    {
        $this->setCommandLoader(new ContainerCommandLoader($this->kasi, $this->commandMap));
