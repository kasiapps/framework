...
use Kasi\Console\Concerns\CreatesMatchingTest;
...
abstract class GeneratorCommand extends Command implements PromptsForMissingInput
{
     ...
     * @return bool|null
     *
     * @throws \Kasi\Contracts\Filesystem\FileNotFoundException
     */
    ...
    protected function getPath($name)
    {
        ...
        return $this->kasi['path'].'/'.str_replace('\\', '/', $name).'.php';
    }
    ...
    {
        $views = $this->kasi['config']['view.paths'][0] ?? resource_path('views');
