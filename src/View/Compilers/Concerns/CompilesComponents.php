...
trait CompilesComponents
{
    ...
    public static function compileClassComponentOpening(string $component, string $alias, string $data, string $hash)
    {
        return implode("\n", [
            ...
            '<?php $component = '.$component.'::resolve('.($data ?: '[]').' + (isset($attributes) && $attributes instanceof Kasi\View\ComponentAttributeBag ? $attributes->all() : [])); ?>',
    ...
    {
        return "<?php \$attributes ??= new \\Kasi\\View\\ComponentAttributeBag;

\$__newAttributes = [];
\$__propNames = \Kasi\View\ComponentAttributeBag::extractPropNames({$expression});
...
\$attributes = new \Kasi\View\ComponentAttributeBag(\$__newAttributes);
