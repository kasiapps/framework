...
use Kasi\Contracts\Support\MessageProvider;
use Kasi\Contracts\Support\Renderable;
use Kasi\Contracts\View\Engine;
use Kasi\Contracts\View\View as ViewContract;
...
class View implements ArrayAccess, Htmlable, Stringable, ViewContract
{
     ...
     *
     * @var \Kasi\Contracts\View\Engine
     */
    protected $engine;
     ...
     *
     * @param  \Kasi\View\Factory  $factory
     * @param  \Kasi\Contracts\View\Engine  $engine
     * @param  string  $view
     * @param  string  $path
     * @param  mixed  $data
     * @return void
     ...
     *
     * @param  \Kasi\Contracts\Support\MessageProvider|array|string  $provider
     * @param  string  $bag
     * @return $this
     */
     ...
     *
     * @return \Kasi\Contracts\View\Engine
     */
