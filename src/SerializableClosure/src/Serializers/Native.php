...
namespace Kasi\SerializableClosure\Serializers;

use Closure;
use DateTimeInterface;
use Kasi\SerializableClosure\Contracts\Serializable;
use Kasi\SerializableClosure\SerializableClosure;
use Kasi\SerializableClosure\Support\ClosureScope;
use Kasi\SerializableClosure\Support\ClosureStream;
use Kasi\SerializableClosure\Support\ReflectionClosure;
use Kasi\SerializableClosure\Support\SelfReference;
...
class Native implements Serializable
{
     ...
     *
     * @var \Kasi\SerializableClosure\Support\ReflectionClosure|null
     */
    protected $reflector;
     ...
     * The closure's scope.
     *
     * @var \Kasi\SerializableClosure\Support\ClosureScope|null
     */
    protected $scope;
     ...
     */
    const ARRAY_RECURSIVE_KEY = 'KASI_SERIALIZABLE_RECURSIVE_KEY';
     ...
     *
     * @param  mixed  $data
     * @param  \Kasi\SerializableClosure\Support\ClosureScope  $storage
     * @return void
     */
     ...
     *
     * @return \Kasi\SerializableClosure\Support\ReflectionClosure
     */
