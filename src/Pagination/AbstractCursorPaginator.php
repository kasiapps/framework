 ...
 *
 * @mixin \Kasi\Support\Collection<TKey, TValue>
 */
abstract class AbstractCursorPaginator implements Htmlable, Stringable
{
     ...
     *
     * @var \Kasi\Support\Collection<TKey, TValue>
     */
    protected $items;
     ...
     * The current cursor.
     *
     * @var \Kasi\Pagination\Cursor|null
     */
    protected $cursor;
     ...
     *
     * @param  \Kasi\Pagination\Cursor|null  $cursor
     * @return string
     */
     ...
     *
     * @return \Kasi\Pagination\Cursor|null
     */
     ...
     * @template TSetValue
     *
     * @param  \Kasi\Support\Collection<TSetKey, TSetValue>  $collection
     * @return $this
     *
