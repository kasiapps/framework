...
/**
 * @mixin \Kasi\Http\Client\PendingRequest
 */
class Factory
{
    use Macroable {
     ...
     *
     * @param  string  $url
     * @param  \Kasi\Http\Client\Response|\GuzzleHttp\Promise\PromiseInterface|callable|int|string|array  $callback
     * @return $this
     */
     ...
     * @param  \Kasi\Http\Client\Response|null  $response
     * @return void
     */
     ...
     *
     * @return \Kasi\Http\Client\PendingRequest
     */
