...
use Kasi\Session\SymfonySessionDecorator;
...
class Request extends SymfonyRequest implements Arrayable, ArrayAccess
{
    ...
    /**
     * Create a new Kasi HTTP request from server variables.
     *
     * @return static
     */
    ...
    /**
     * This method belongs to Symfony HttpFoundation and is not usually needed when using Kasi.
     *
    ...
    /**
     * Create a new request instance from the given Kasi request.
     *
     * @param  \Kasi\Http\Request  $from
     * @param  \Kasi\Http\Request|null  $to
     * @return static
     */
    ...
    /**
     * Create an Kasi request from a Symfony instance.
     *
     ...
     * @return void
     */
    public function setKasiSession($session)
    {
     ...
     * @param  mixed  $default
     * @return \Kasi\Routing\Route|object|string|null
     */
