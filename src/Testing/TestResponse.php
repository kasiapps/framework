...
use ArrayAccess;
use Closure;
use Kasi\Contracts\Support\MessageBag;
...
use Kasi\Support\Traits\Tappable;
use Kasi\Support\ViewErrorBag;
use Kasi\Testing\Constraints\SeeInOrder;
use Kasi\Testing\Fluent\AssertableJson;
use Kasi\Testing\TestResponseAssert as PHPUnit;
use LogicException;
...
class TestResponse implements ArrayAccess
{
     ...
     *
     * @return \Kasi\Testing\AssertableJsonString
     *
     * @throws \Throwable
     */
     ...
     *
     * @param  \Kasi\Support\Collection  $exceptions
     * @return $this
     */
