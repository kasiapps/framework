...
use Kasi\Contracts\Container\Container as ContainerContract;
use Kasi\Contracts\Events\Dispatcher as DispatcherContract;
use Kasi\Contracts\Events\ShouldDispatchAfterCommit;
use Kasi\Contracts\Events\ShouldHandleEventsAfterCommit;
...
use Kasi\Support\Traits\ReflectsClosures;
use ReflectionClass;
...
class Dispatcher implements DispatcherContract
{
     ...
     *
     * @param  \Kasi\Contracts\Container\Container|null  $container
     * @return void
     */
     ...
     *
     * @param  \Kasi\Events\QueuedClosure|callable|array|class-string|string  $events
     * @param  \Kasi\Events\QueuedClosure|callable|array|class-string|null  $listener
     * @return void
     */
     ...
     *
     * @param  \Kasi\Contracts\Broadcasting\ShouldBroadcast  $event
     * @return void
     */
     ...
     *
     * @param  mixed  $listener
     * @param  \Kasi\Events\CallQueuedListener  $job
     * @return mixed
     */
     ...
     *
     * @return \Kasi\Database\DatabaseTransactionsManager|null
     */
