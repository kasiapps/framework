...
use Kasi\Broadcasting\Broadcasters\AblyBroadcaster;
use Kasi\Broadcasting\Broadcasters\LogBroadcaster;
use Kasi\Broadcasting\Broadcasters\NullBroadcaster;
use Kasi\Broadcasting\Broadcasters\PusherBroadcaster;
use Kasi\Broadcasting\Broadcasters\RedisBroadcaster;
use Kasi\Bus\UniqueLock;
use Kasi\Contracts\Broadcasting\Factory as FactoryContract;
...
use Kasi\Contracts\Foundation\CachesRoutes;
use InvalidArgumentException;
use Psr\Log\LoggerInterface;
use Pusher\Pusher;

/**
 * @mixin \Kasi\Contracts\Broadcasting\Broadcaster
 */
class BroadcastManager implements FactoryContract
{
     ...
     *
     * @param  \Kasi\Contracts\Container\Container  $app
     * @return void
     */
    ...
    public function routes(?array $attributes = null)
    {
        ...
        $this->app['router']->group($attributes, function ($router) {
            ...
            )->withoutMiddleware([\Kasi\Foundation\Http\Middleware\VerifyCsrfToken::class]);
        });
    }
     ...
     *
     * @param  \Kasi\Http\Request|null  $request
     * @return string|null
     */
