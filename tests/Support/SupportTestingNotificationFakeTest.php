...
{
    /**
     * @var \Kasi\Support\Testing\Fakes\NotificationFake
     */
    private $fake;

    /**
     * @var \Kasi\Tests\Support\NotificationStub
     */
    private $notification;

    /**
     * @var \Kasi\Tests\Support\UserStub
     */
    private $user;
    ...
    public function testAssertSentTo()
    {
        try {
            ...
            $this->assertStringContainsString('The expected [Kasi\Tests\Support\NotificationStub] notification was not sent.', $e->getMessage());
        }
    ...
    public function testAssertNotSentTo()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('The unexpected [Kasi\Tests\Support\NotificationStub] notification was sent.', $e->getMessage());
        }
    }
