...
{
    /**
     * @var \Kasi\Support\Testing\Fakes\QueueFake
     */
    private $fake;

    /**
     * @var \Kasi\Tests\Support\JobStub
     */
    private $job;
    ...
    public function testAssertPushed()
    {
        try {
            ...
            $this->assertStringContainsString('The expected [Kasi\Tests\Support\JobStub] job was not pushed.', $e->getMessage());
        }
    ...
    public function testAssertNotPushed()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('The unexpected [Kasi\Tests\Support\JobStub] job was pushed.', $e->getMessage());
        }
    }
    ...
    public function testAssertPushedTimes()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('The expected [Kasi\Tests\Support\JobStub] job was pushed 2 times instead of 1 times.', $e->getMessage());
        }
    ...
    public function testAssertPushedWithChainErrorHandling()
    {
        try {
            ...
            $this->assertStringContainsString('The expected [Kasi\Tests\Support\JobWithChainStub] job was not pushed.', $e->getMessage());
        }
