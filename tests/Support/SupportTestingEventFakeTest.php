...
class SupportTestingEventFakeTest extends TestCase
{
    ...
    public function testAssertDispatched()
    {
        try {
            ...
            $this->assertStringContainsString('The expected [Kasi\Tests\Support\EventStub] event was not dispatched.', $e->getMessage());
        }
    ...
    public function testAssertDispatchedWithCallbackInt()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('The expected [Kasi\Tests\Support\EventStub] event was dispatched 2 times instead of 1 times.', $e->getMessage());
        }
    ...
    public function testAssertNotDispatched()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('The unexpected [Kasi\Tests\Support\EventStub] event was dispatched.', $e->getMessage());
        }
    }
