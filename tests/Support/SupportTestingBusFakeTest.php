...
use Kasi\Support\Testing\Fakes\BatchRepositoryFake;
use Kasi\Support\Testing\Fakes\BusFake;
use Kasi\Support\Testing\Fakes\PendingBatchFake;
use Mockery as m;
...
class SupportTestingBusFakeTest extends TestCase
{
    ...
    public function testAssertDispatched()
    {
        try {
            ...
            $this->assertStringContainsString('The expected [Kasi\Tests\Support\BusJobStub] job was not dispatched.', $e->getMessage());
        }
    ...
    public function testAssertDispatchedAfterResponse()
    {
        try {
            ...
            $this->assertStringContainsString('The expected [Kasi\Tests\Support\BusJobStub] job was not dispatched after sending the response.', $e->getMessage());
        }
    ...
    public function testAssertDispatchedSync()
    {
        try {
            ...
            $this->assertStringContainsString('The expected [Kasi\Tests\Support\BusJobStub] job was not dispatched synchronously.', $e->getMessage());
        }
    ...
    public function testAssertDispatchedWithCallbackInt()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('The expected [Kasi\Tests\Support\BusJobStub] job was pushed 2 times instead of 1 times.', $e->getMessage());
        }
    ...
    public function testAssertDispatchedSyncWithCallbackInt()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('The expected [Kasi\Tests\Support\BusJobStub] job was synchronously pushed 2 times instead of 1 times.', $e->getMessage());
        }
    ...
    public function testAssertDispatchedWithCallbackFunction()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('The expected [Kasi\Tests\Support\OtherBusJobStub] job was not dispatched.', $e->getMessage());
        }
    ...
    public function testAssertDispatchedAfterResponseWithCallbackFunction()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('The expected [Kasi\Tests\Support\OtherBusJobStub] job was not dispatched after sending the response.', $e->getMessage());
        }
    ...
    public function testAssertDispatchedAfterResponseTimesWithCallbackFunction()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('The expected [Kasi\Tests\Support\OtherBusJobStub] job was pushed 1 times instead of 2 times.', $e->getMessage());
        }
    ...
    public function testAssertDispatchedSyncWithCallbackFunction()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('The expected [Kasi\Tests\Support\OtherBusJobStub] job was not dispatched synchronously.', $e->getMessage());
        }
    ...
    public function testAssertDispatchedSyncTimesWithCallbackFunction()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('The expected [Kasi\Tests\Support\OtherBusJobStub] job was synchronously pushed 1 times instead of 2 times.', $e->getMessage());
        }
    ...
    public function testAssertNotDispatched()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('The unexpected [Kasi\Tests\Support\BusJobStub] job was dispatched.', $e->getMessage());
        }
    }
    ...
    public function testAssertNotDispatchedAfterResponse()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('The unexpected [Kasi\Tests\Support\BusJobStub] job was dispatched after sending the response.', $e->getMessage());
        }
    }
    ...
    public function testAssertNotDispatchedSync()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('The unexpected [Kasi\Tests\Support\BusJobStub] job was dispatched synchronously.', $e->getMessage());
        }
    }
