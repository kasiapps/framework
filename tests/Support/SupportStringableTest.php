...
class SupportStringableTest extends TestCase
{
    /**
     * @param  string  $string
     * @return \Kasi\Support\Stringable
     */
    ...
    {
        $this->assertTrue($this->stringable('https://kasi.com')->isUrl());
    ...
    {
        $this->assertTrue($this->stringable('Hello, Kasi!')->isMatch('/.*,.*!/'));
        $this->assertTrue($this->stringable('Hello, Kasi!')->isMatch('/^.*$(.*)/'));
        $this->assertTrue($this->stringable('Hello, Kasi!')->isMatch('/kasi/i'));
        $this->assertTrue($this->stringable('Hello, Kasi!')->isMatch('/^(.*(.*(.*)))/'));

        $this->assertFalse($this->stringable('Hello, Kasi!')->isMatch('/H.o/'));
        $this->assertFalse($this->stringable('Hello, Kasi!')->isMatch('/^kasi!/i'));
        $this->assertFalse($this->stringable('Hello, Kasi!')->isMatch('/kasi!(.*)/'));
        $this->assertFalse($this->stringable('Hello, Kasi!')->isMatch('/^[a-zA-Z,!]+$/'));

        $this->assertTrue($this->stringable('Hello, Kasi!')->isMatch(['/.*,.*!/', '/H.o/']));
        $this->assertTrue($this->stringable('Hello, Kasi!')->isMatch(['/^kasi!/i', '/^.*$(.*)/']));
        $this->assertTrue($this->stringable('Hello, Kasi!')->isMatch(['/kasi/i', '/kasi!(.*)/']));
        $this->assertTrue($this->stringable('Hello, Kasi!')->isMatch(['/^[a-zA-Z,!]+$/', '/^(.*(.*(.*)))/']));
    }
    ...
    {
        $this->assertSame(' kasi php framework ', (string) $this->stringable(' kasi   php  framework ')->deduplicate());
    ...
    public function testUcsplitOnStringable()
    {
        ...
        $this->assertSame(['Hello', 'From', 'Kasi'], $this->stringable('HelloFromKasi')->ucsplit()->toArray());
    ...
    {
        $this->assertSame('Kasi'.PHP_EOL, (string) $this->stringable('Kasi')->newLine());
    ...
    public function testSquish()
    {
        ...
        $this->assertSame('words with spaces', (string) $this->stringable('
            ...
            spaces
        ')->squish());
        $this->assertSame('kasi php framework', (string) $this->stringable('   kasi   php   framework   ')->squish());
    ...
    {
        $this->assertSame('kasi-php-framework', (string) $this->stringable('KasiPhpFramework')->kebab());
    }
    ...
    {
        $this->assertSame('Kasi is...',
            (string) $this->stringable('Kasi is a free, open source PHP web application framework.')->limit(10)
        );
    ...
    {
        $this->assertSame('kasi_p_h_p_framework', (string) $this->stringable('KasiPHPFramework')->snake());
        $this->assertSame('kasi_php_framework', (string) $this->stringable('KasiPhpFramework')->snake());
        $this->assertSame('kasi php framework', (string) $this->stringable('KasiPhpFramework')->snake(' '));
        $this->assertSame('kasi_php_framework', (string) $this->stringable('Kasi Php Framework')->snake());
        $this->assertSame('kasi_php_framework', (string) $this->stringable('Kasi    Php      Framework   ')->snake());
        // ensure cache keys don't overlap
        $this->assertSame('kasi__php__framework', (string) $this->stringable('KasiPhpFramework')->snake('__'));
        $this->assertSame('kasi_php_framework_', (string) $this->stringable('KasiPhpFramework_')->snake('_'));
        $this->assertSame('kasi_php_framework', (string) $this->stringable('kasi php Framework')->snake());
        $this->assertSame('kasi_php_frame_work', (string) $this->stringable('kasi php FrameWork')->snake());
    ...
    {
        $this->assertSame('KasiPHPFramework', (string) $this->stringable('kasi_p_h_p_framework')->studly());
        $this->assertSame('KasiPhpFramework', (string) $this->stringable('kasi_php_framework')->studly());
        $this->assertSame('KasiPhPFramework', (string) $this->stringable('kasi-phP-framework')->studly());
        $this->assertSame('KasiPhpFramework', (string) $this->stringable('kasi  -_-  php   -_-   framework   ')->studly());
    ...
    {
        $this->assertSame('KasiPHPFramework', (string) $this->stringable('kasi_p_h_p_framework')->pascal());
        $this->assertSame('KasiPhpFramework', (string) $this->stringable('kasi_php_framework')->pascal());
        $this->assertSame('KasiPhPFramework', (string) $this->stringable('kasi-phP-framework')->pascal());
        $this->assertSame('KasiPhpFramework', (string) $this->stringable('kasi  -_-  php   -_-   framework   ')->pascal());
    ...
    {
        $this->assertSame('kasiPHPFramework', (string) $this->stringable('Kasi_p_h_p_framework')->camel());
        $this->assertSame('kasiPhpFramework', (string) $this->stringable('Kasi_php_framework')->camel());
        $this->assertSame('kasiPhPFramework', (string) $this->stringable('Kasi-phP-framework')->camel());
        $this->assertSame('kasiPhpFramework', (string) $this->stringable('Kasi  -_-  php   -_-   framework   ')->camel());
    ...
    {
        $this->assertSame(3, $this->stringable('kasiPHPFramework')->substrCount('a'));
        $this->assertSame(0, $this->stringable('kasiPHPFramework')->substrCount('z'));
        $this->assertSame(1, $this->stringable('kasiPHPFramework')->substrCount('l', 2));
        $this->assertSame(0, $this->stringable('kasiPHPFramework')->substrCount('z', 2));
        $this->assertSame(1, $this->stringable('kasiPHPFramework')->substrCount('k', -1));
        $this->assertSame(1, $this->stringable('kasiPHPFramework')->substrCount('k', -1));
        $this->assertSame(1, $this->stringable('kasiPHPFramework')->substrCount('a', 1, 2));
        $this->assertSame(1, $this->stringable('kasiPHPFramework')->substrCount('a', 1, 2));
        $this->assertSame(3, $this->stringable('kasiPHPFramework')->substrCount('a', 1, -2));
        $this->assertSame(1, $this->stringable('kasiPHPFramework')->substrCount('a', -10, -3));
    }
    ...
    public function testSubstrReplace()
    {
        ...
        $this->assertSame('The Kasi Framework', (string) $this->stringable('The Framework')->substrReplace('Kasi ', 4, 0));
        $this->assertSame('Kasi – The PHP Framework for Web Artisans', (string) $this->stringable('Kasi Framework')->substrReplace('– The PHP Framework for Web Artisans', 8));
    }
    ...
    public function testJsonSerialize()
    {
        ...
        $this->assertSame('"kasi-php-framework"', json_encode($this->stringable('KasiPhpFramework')->kebab()));
        $this->assertSame('["kasi-php-framework"]', json_encode([$this->stringable('KasiPhpFramework')->kebab()]));
        $this->assertSame('{"title":"kasi-php-framework"}', json_encode(['title' => $this->stringable('KasiPhpFramework')->kebab()]));
    }
    ...
    public function testInlineMarkdown()
    {
        ...
        $this->assertEquals("<a href=\"https://kasi.com\"><strong>Kasi</strong></a>\n", $this->stringable('[**Kasi**](https://kasi.com)')->inlineMarkdown());
    ...
    public function testWordCount()
    {
        ...
        $this->assertEquals(10, $this->stringable('Hi, this is my first contribution to the Kasi framework.')->wordCount());
    }
