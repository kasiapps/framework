...
class SupportUriTest extends TestCase
{
    ...
    {
        $uri = Uri::of($originalUri = 'https://kasi.com/docs/installation');

        $this->assertEquals('https', $uri->scheme());
        $this->assertNull($uri->user());
        $this->assertNull($uri->password());
        $this->assertEquals('kasi.com', $uri->host());
        ...
        $uri = Uri::of('https://taylor:password@kasi.com/docs/installation?version=1#hello');
    ...
    public function test_uri_building()
    {
        ...
        $this->assertEquals('https://taylor:password@kasi.com:80/docs/installation?version=1#hello', (string) $uri);
    }

    public function test_complicated_query_string_manipulation()
    {
        $uri = Uri::of('https://kasi.com');
        ...
        $uri = Uri::of('https://kasi.com?tags[]=foo');
        ...
        $uri = Uri::of('https://kasi.com?tag=foo');
    ...
    {
        $uri = Uri::of('https://kasi.com/docs/11.x/installation')->withQuery(['tags' => ['first', 'second']]);

        $this->assertEquals('https://kasi.com/docs/11.x/installation?tags[0]=first&tags[1]=second', $uri->decode());
    }
}
