...
use Kasi\Contracts\Debug\ShouldntReport;
use Kasi\Contracts\Support\Responsable;
use Kasi\Support\Facades\Config;
...
class ExceptionHandlerTest extends TestCase
{
    ...
    {
        $app->singleton('Kasi\Contracts\Debug\ExceptionHandler', 'Kasi\Foundation\Exceptions\Handler');
    }
...
\$kasi = Orchestra\Testbench\Foundation\Application::create(basePath: '$basePath', options: ['extra' => ['providers' => $providers]]);
\$kasi->singleton('Kasi\Contracts\Debug\ExceptionHandler', 'Kasi\Foundation\Exceptions\Handler');

\$kernel = \$kasi[Kasi\Contracts\Console\Kernel::class];
