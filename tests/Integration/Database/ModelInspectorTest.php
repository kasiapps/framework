...
use Kasi\Database\Eloquent\ModelInspector;
...
class ModelInspectorTest extends DatabaseTestCase
{
    ...
    private function assertModelInfo(array $modelInfo)
    {
        ...
        $this->assertEqualsCanonicalizing([
            'name' => 'parentModel',
            'type' => 'BelongsTo',
            'related' => "Kasi\Tests\Integration\Database\ParentTestModel",
        ...
        $this->assertEquals("Kasi\Tests\Integration\Database\ModelInspectorTestModelObserver@created", $modelInfo['observers'][0]['observer'][0]);
    }
