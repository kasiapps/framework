...
use Kasi\Database\Eloquent\Collection as DatabaseCollection;
...
class EloquentPivotSerializationTest extends DatabaseTestCase
{
    ...
    {
        $user = PivotSerializationTestUser::forceCreate(['email' => 'taylor@kasi.com']);
    ...
    {
        $user = PivotSerializationTestUser::forceCreate(['email' => 'taylor@kasi.com']);
        $user2 = PivotSerializationTestUser::forceCreate(['email' => 'mohamed@kasi.com']);
        $project = PivotSerializationTestProject::forceCreate(['name' => 'Test Project']);
