...
class ContextIntegrationTest extends TestCase
{
    ...
    public function test_it_handles_eloquent()
    {
        ...
        $this->assertSame([
            'data' => [
                'model' => 'O:45:"Kasi\Contracts\Database\ModelIdentifier":5:{s:5:"class";s:31:"Kasi\Foundation\Auth\User";s:2:"id";i:1;s:9:"relations";a:0:{}s:10:"connection";s:7:"testing";s:15:"collectionClass";N;}',
                'number' => 'i:55;',
            ],
            'hidden' => [],
        ], $dehydrated);
