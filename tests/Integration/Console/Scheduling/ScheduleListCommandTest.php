...
namespace Kasi\Tests\Integration\Console\Scheduling;
...
class ScheduleListCommandTest extends TestCase
{
    ...
    public function testDisplaySchedule()
    {
        ...
        $this->artisan(ScheduleListCommand::class)
            ...
            ->expectsOutput('  * *     * *      *  Kasi\Tests\Integration\Console\Scheduling\FooJob  Next Due: 1 minute from now')
            ->expectsOutput('  * *     * *      *  Kasi\Tests\Integration\Console\Scheduling\FooParamJob  Next Due: 1 minute from now')
            ...
            ->expectsOutput('  * *     * *      *  Kasi\Tests\Integration\Console\Scheduling\FooCall  Next Due: 1 minute from now')
            ->expectsOutput('  * *     * *      *  Closure at: Kasi\Tests\Integration\Console\Scheduling\FooCall::fooFunction  Next Due: 1 minute from now')
