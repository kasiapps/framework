...
use Kasi\Queue\Attributes\WithoutRelations;
...
class ModelSerializationTest extends TestCase
{
    ...
    public function testItSerializeUserOnDefaultConnection()
    {
        ...
        $this->assertSame('mohamed@kasi.com', $unSerialized->user->email);
        ...
        $this->assertSame('mohamed@kasi.com', $unSerialized->users[0]->email);
        $this->assertSame($defaultConnection, $unSerialized->users[1]->getConnectionName());
        $this->assertSame('taylor@kasi.com', $unSerialized->users[1]->email);
    }
    ...
    {
        ModelSerializationTestUser::create(['email' => 'mohamed@kasi.com']);
        ModelSerializationTestUser::create(['email' => 'taylor@kasi.com']);
        ...
        $this->assertSame('taylor@kasi.com', $unserialized->users->first()->email);
        $this->assertSame('mohamed@kasi.com', $unserialized->users->last()->email);
    }

    public function testItCanUnserializeACollectionInCorrectOrderAndHandleDeletedModels()
    {
        ModelSerializationTestUser::create(['email' => '2@kasi.com']);
        ModelSerializationTestUser::create(['email' => '3@kasi.com']);
        ModelSerializationTestUser::create(['email' => '1@kasi.com']);

        $serialized = serialize(new CollectionSerializationTestClass(
            ModelSerializationTestUser::orderByDesc('email')->get()
        ));

        ModelSerializationTestUser::where(['email' => '2@kasi.com'])->delete();

        $unserialized = unserialize($serialized);

        $this->assertCount(2, $unserialized->users);

        $this->assertSame('3@kasi.com', $unserialized->users->first()->email);
        $this->assertSame('1@kasi.com', $unserialized->users->last()->email);
    }

    public function testItCanUnserializeCustomCollection()
    {
        ModelSerializationTestCustomUser::create(['email' => 'mohamed@kasi.com']);
        ModelSerializationTestCustomUser::create(['email' => 'taylor@kasi.com']);
    ...
    public function test_model_serialization_structure()
    {
        ...
        $this->assertSame(
            'O:78:"Kasi\\Tests\\Integration\\Queue\\ModelSerializationParentAccessibleTestClass":2:{s:4:"user";O:45:"Kasi\\Contracts\\Database\\ModelIdentifier":5:{s:5:"class";s:61:"Kasi\\Tests\\Integration\\Queue\\ModelSerializationTestUser";s:2:"id";i:1;s:9:"relations";a:0:{}s:10:"connection";s:7:"testing";s:15:"collectionClass";N;}s:8:"'."\0".'*'."\0".'user2";O:45:"Kasi\\Contracts\\Database\\ModelIdentifier":5:{s:5:"class";s:61:"Kasi\\Tests\\Integration\\Queue\\ModelSerializationTestUser";s:2:"id";i:1;s:9:"relations";a:0:{}s:10:"connection";s:7:"testing";s:15:"collectionClass";N;}}', $serialized
        );
    }
    ...
    public function test_it_respects_without_relations_attribute()
    {
        ...
        $this->assertSame(
            'O:69:"Kasi\Tests\Integration\Queue\ModelSerializationWithoutRelations":1:{s:4:"user";O:45:"Kasi\Contracts\Database\ModelIdentifier":5:{s:5:"class";s:39:"Kasi\Tests\Integration\Queue\User";s:2:"id";i:1;s:9:"relations";a:0:{}s:10:"connection";s:7:"testing";s:15:"collectionClass";N;}}', $serialized
        );
    }
    ...
    public function test_it_respects_without_relations_attribute_applied_to_class()
    {
        ...
        $this->assertSame(
            'O:83:"Kasi\Tests\Integration\Queue\ModelSerializationAttributeTargetsClassTestClass":2:{s:4:"user";O:45:"Kasi\Contracts\Database\ModelIdentifier":5:{s:5:"class";s:39:"Kasi\Tests\Integration\Queue\User";s:2:"id";i:1;s:9:"relations";a:0:{}s:10:"connection";s:7:"testing";s:15:"collectionClass";N;}s:5:"value";O:50:"Kasi\Tests\Integration\Queue\DataValueObject":1:{s:5:"value";s:5:"hello";}}',
            $serialized
        );
