...
use Kasi\Foundation\Http\Middleware\ValidatePostSize;
use Kasi\Http\Exceptions\PostTooLargeException;
use Kasi\Http\Request;
use Kasi\Http\Resources\ConditionallyLoadsAttributes;
use Kasi\Http\Resources\Json\JsonResource;
use Kasi\Http\Resources\MergeValue;
use Kasi\Http\Resources\MissingValue;
use Kasi\Pagination\Cursor;
use Kasi\Pagination\CursorPaginator;
use Kasi\Pagination\LengthAwarePaginator;
use Kasi\Support\Collection;
use Kasi\Support\Facades\Route;
use Kasi\Tests\Integration\Http\Fixtures\Author;
use Kasi\Tests\Integration\Http\Fixtures\AuthorResourceWithOptionalRelationship;
use Kasi\Tests\Integration\Http\Fixtures\EmptyPostCollectionResource;
use Kasi\Tests\Integration\Http\Fixtures\ObjectResource;
use Kasi\Tests\Integration\Http\Fixtures\Post;
use Kasi\Tests\Integration\Http\Fixtures\PostCollectionResource;
use Kasi\Tests\Integration\Http\Fixtures\PostCollectionResourceWithPaginationInformation;
use Kasi\Tests\Integration\Http\Fixtures\PostModelCollectionResource;
use Kasi\Tests\Integration\Http\Fixtures\PostResource;
use Kasi\Tests\Integration\Http\Fixtures\PostResourceWithAnonymousResourceCollectionWithPaginationInformation;
use Kasi\Tests\Integration\Http\Fixtures\PostResourceWithExtraData;
use Kasi\Tests\Integration\Http\Fixtures\PostResourceWithJsonOptions;
use Kasi\Tests\Integration\Http\Fixtures\PostResourceWithJsonOptionsAndTypeHints;
use Kasi\Tests\Integration\Http\Fixtures\PostResourceWithOptionalAppendedAttributes;
use Kasi\Tests\Integration\Http\Fixtures\PostResourceWithOptionalAttributes;
use Kasi\Tests\Integration\Http\Fixtures\PostResourceWithOptionalData;
use Kasi\Tests\Integration\Http\Fixtures\PostResourceWithOptionalHasAttributes;
use Kasi\Tests\Integration\Http\Fixtures\PostResourceWithOptionalMerging;
use Kasi\Tests\Integration\Http\Fixtures\PostResourceWithOptionalPivotRelationship;
use Kasi\Tests\Integration\Http\Fixtures\PostResourceWithOptionalRelationship;
use Kasi\Tests\Integration\Http\Fixtures\PostResourceWithOptionalRelationshipAggregates;
use Kasi\Tests\Integration\Http\Fixtures\PostResourceWithOptionalRelationshipCounts;
use Kasi\Tests\Integration\Http\Fixtures\PostResourceWithOptionalRelationshipExists;
use Kasi\Tests\Integration\Http\Fixtures\PostResourceWithOptionalRelationshipUsingNamedParameters;
use Kasi\Tests\Integration\Http\Fixtures\PostResourceWithoutWrap;
use Kasi\Tests\Integration\Http\Fixtures\PostResourceWithUnlessOptionalData;
use Kasi\Tests\Integration\Http\Fixtures\ReallyEmptyPostResource;
use Kasi\Tests\Integration\Http\Fixtures\ResourceWithPreservedKeys;
use Kasi\Tests\Integration\Http\Fixtures\SerializablePostResource;
use Kasi\Tests\Integration\Http\Fixtures\Subscription;
use LogicException;
...
class ResourceTest extends TestCase
{
    ...
    {
        Route::get('/', function () {
            $collection = collect([new Post(['id' => 2, 'title' => 'Kasi Nova'])]);
            $paginator = new LengthAwarePaginator(
                $collection, 3, 1, 2
            );
        ...
        $response = $this->withoutExceptionHandling()->get(
            '/?framework=kasi&author=Otwell&page=2', ['Accept' => 'application/json']
        );
        ...
        $response->assertJson([
            ...
            'links' => [
                'first' => '/?framework=kasi&author=Otwell&page=1',
                'last' => '/?framework=kasi&author=Otwell&page=3',
                'prev' => '/?framework=kasi&author=Otwell&page=1',
                'next' => '/?framework=kasi&author=Otwell&page=3',
            ],
            'meta' => [
                'current_page' => 2,
                'from' => 2,
    ...
    public function testCursorPaginatorResourceCanPreserveQueryParameters()
    {
        ...
        $response = $this->withoutExceptionHandling()->get(
            '/?framework=kasi&author=Otwell', ['Accept' => 'application/json']
        );
        ...
        $response->assertJson([
            ...
            'links' => [
                ...
                'last' => null,
                'prev' => null,
                'next' => '/?framework=kasi&author=Otwell&cursor='.(new Cursor(['id' => 5]))->encode(),
            ],
            'meta' => [
                'path' => '/',
                'per_page' => 1,
