...
use Kasi\Http\Client\Events\ResponseReceived;
use Kasi\Http\Client\Factory;
use Kasi\Http\Client\PendingRequest;
use Kasi\Http\Client\Pool;
use Kasi\Http\Client\Request;
use Kasi\Http\Client\RequestException;
use Kasi\Http\Client\Response;
use Kasi\Http\Client\ResponseSequence;
use Kasi\Http\Response as HttpResponse;
...
class HttpClientTest extends TestCase
{
    ...
    public function testStubbedResponsesAreReturnedAfterFaking()
    {
        ...
        $response = $this->factory->post('http://kasi.com/test-missing-page');
    ...
    {
        $this->factory->fake([
            'vapor.kasi.com' => $this->factory::response('', HttpResponse::HTTP_CREATED),
            'forge.kasi.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);

        $response = $this->factory->post('http://vapor.kasi.com');
        $this->assertTrue($response->created());

        $response = $this->factory->post('http://forge.kasi.com');
    ...
    public function testStatusCodeShorthand()
    {
        $this->factory->fake([
            'forge.kasi.com' => 204,
            'vapor.kasi.com' => HttpResponse::HTTP_CREATED,
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.kasi.com' => $this->factory::response('', HttpResponse::HTTP_ACCEPTED),
            'forge.kasi.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.kasi.com' => $this->factory::response('', HttpResponse::HTTP_MOVED_PERMANENTLY),
            'forge.kasi.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.kasi.com' => $this->factory::response('', HttpResponse::HTTP_NO_CONTENT),
            'forge.kasi.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.kasi.com' => $this->factory::response('', HttpResponse::HTTP_FOUND),
            'forge.kasi.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.kasi.com' => $this->factory::response('', HttpResponse::HTTP_NOT_MODIFIED),
            'forge.kasi.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);

        $response = $this->factory->post('https://vapor.kasi.com');
        $this->assertTrue($response->notModified());

        $response = $this->factory->post('https://forge.kasi.com');
    ...
    {
        $this->factory->fake([
            'vapor.kasi.com' => $this->factory::response('', HttpResponse::HTTP_BAD_REQUEST),
            'forge.kasi.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.kasi.com' => $this->factory::response('', HttpResponse::HTTP_PAYMENT_REQUIRED),
            'forge.kasi.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.kasi.com' => $this->factory::response('', HttpResponse::HTTP_REQUEST_TIMEOUT),
            'forge.kasi.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.kasi.com' => $this->factory::response('', HttpResponse::HTTP_CONFLICT),
            'forge.kasi.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.kasi.com' => $this->factory::response('', HttpResponse::HTTP_UNPROCESSABLE_ENTITY),
            'forge.kasi.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.kasi.com' => $this->factory::response('', HttpResponse::HTTP_TOO_MANY_REQUESTS),
            'forge.kasi.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'kasi.com' => $this->factory::response('', 401),
        ]);

        $response = $this->factory->post('http://kasi.com');
    ...
    {
        $this->factory->fake([
            'kasi.com' => $this->factory::response('', 403),
        ]);
    ...
    {
        $this->factory->fake([
            'kasi.com' => $this->factory::response('', 404),
        ]);
    ...
    public function testItCanSendUserAgent()
    {
        ...
        $this->factory->withUserAgent('Kasi')->post('http://foo.com/json');

        $this->factory->assertSent(function (Request $request) {
            return $request->url() === 'http://foo.com/json' &&
                $request->hasHeader('User-Agent', 'Kasi');
        });
    }
    ...
    public function testItOnlySendsOneUserAgentHeader()
    {
        ...
        $this->factory->withUserAgent('Kasi')
    ...
    public function testSequenceBuilderCanKeepGoingWhenEmpty()
    {
        ...
        $response = $this->factory->get('https://kasi.com');
        $this->assertSame('Ok', $response->body());

        // The sequence is empty, but it should not fail.
        $this->factory->get('https://kasi.com');
    }
    ...
    public function testWithCookies()
    {
        ...
        $this->assertSame('https://kasi.com', $responseCookie['Domain']);
    }
    ...
    public function testWithQueryParameters()
    {
        ...
        $this->factory->assertSent(function (Request $request) {
            return $request->url() === 'https://kasi.com?foo=bar';
        });
    }
    ...
    public function testWithArrayQueryParameters()
    {
        ...
        $this->factory->assertSent(function (Request $request) {
            return $request->url() === 'https://kasi.com?foo%5B0%5D=bar&foo%5B1%5D=baz';
        });
    }
    ...
    public function testWithQueryParametersAllowsAddingMoreOnRequest()
    {
        ...
        $this->factory->assertSent(function (Request $request) {
            return $request->url() === 'https://kasi.com?foo=bar&baz=qux';
        });
    }
    ...
    public function testGetWithArrayQueryParamEncodes()
    {
        ...
        $this->factory->get('http://foo.com/get', ['foo;bar; space test' => 'kasi']);

        $this->factory->assertSent(function (Request $request) {
            return $request->url() === 'http://foo.com/get?foo%3Bbar%3B%20space%20test=kasi'
                && $request['foo;bar; space test'] === 'kasi';
        });
    }
    ...
    public function testOnErrorDoesntCallClosureOnInformational()
    {
        ...
        $client = $this->factory->fake([
            'kasi.com' => $this->factory::response('', 101),
        ]);

        $response = $client->get('kasi.com')
    ...
    public function testOnErrorDoesntCallClosureOnSuccess()
    {
        $status = 0;
        $client = $this->factory->fake([
            'kasi.com' => $this->factory::response('', 201),
        ]);
    ...
    public function testOnErrorDoesntCallClosureOnRedirection()
    {
        $status = 0;
        $client = $this->factory->fake([
            'kasi.com' => $this->factory::response('', 301),
        ]);
    ...
    public function testOnErrorCallsClosureOnServerError()
    {
        $status = 0;
        $client = $this->factory->fake([
            'kasi.com' => $this->factory::response('', 501),
        ]);
    ...
    public function testMiddlewareRunsInPool()
    {
        ...
        $responses = $this->factory->pool(fn (Pool $pool) => [
            $pool->withMiddleware($middleware)->post('https://example.com', ['hyped-for' => 'kasi-movie']),
        ]);
        ...
        $this->assertSame(['hyped-for' => 'kasi-movie'], json_decode(tap($history[0]['request']->getBody())->rewind()->getContents(), true));
    }
    ...
    public function testMiddlewareRunsWhenFaked()
    {
        ...
        $response = $pendingRequest->post('https://example.com', ['hyped-for' => 'kasi-movie']);
    ...
    public function testMiddlewareRunsAndCanChangeRequestOnAssertSent()
    {
        ...
        $pendingRequest->post('https://kasi.example', ['kasi' => 'framework']);

        $this->factory->assertSent(function (Request $request) {
            return
                $request->url() === 'https://kasi.example' &&
    ...
    public function testItCanEnforceFaking()
    {
        ...
        $this->factory->fake(['https://vapor.kasi.com' => Factory::response('ok', 200)]);
        $this->factory->fake(['https://forge.kasi.com' => Factory::response('ok', 200)]);

        $responses = [];
        $responses[] = $this->factory->get('https://vapor.kasi.com')->body();
        $responses[] = $this->factory->get('https://forge.kasi.com')->body();
        $this->assertSame(['ok', 'ok'], $responses);

        $this->expectException(RuntimeException::class);
        $this->expectExceptionMessage('Attempted request to [https://kasi.com] without a matching fake.');
    ...
    public function testItCanSubstituteUrlParams(): void
    {
        ...
        $this->factory->assertSent(function (Request $request) {
            return $request->url() === 'https://kasi.com/docs/9.x/validation';
        });
    }
    ...
    public function testItCanAddGlobalMiddleware()
    {
        ...
        $this->factory->globalMiddleware(Middleware::mapRequest(function ($request) {
            ...
            return $request->withHeader('User-Agent', 'Kasi Framework/1.0')
        ...
        $responses[] = $this->factory->post('http://forge.kasi.com');
        $responses[] = $this->factory->withHeader('shared', 'local')->post('http://vapor.kasi.com');

        $this->assertCount(2, $requests);
        $this->assertCount(2, $responses);

        $this->assertSame(['Kasi Framework/1.0'], $requests[0]->header('User-Agent'));
        ...
        $this->assertSame(['Kasi Framework/1.0'], $requests[1]->header('User-Agent'));
    ...
    public function testItCanAddGlobalRequestMiddleware()
    {
        ...
        $this->factory->post('http://forge.kasi.com');
        $this->factory->post('http://kasi.com');
    ...
    public function testItCanAddGlobalResponseMiddleware()
    {
        ...
        $responses[] = $this->factory->post('http://forge.kasi.com');
        $responses[] = $this->factory->post('http://kasi.com');
    ...
    public function testItReturnsResponse(): void
    {
        ...
        $response = $this->factory->get('http://kasi.com');
    ...
    public function testItCanReturnCustomResponseClass(): void
    {
        ...
        $response = $factory->get('http://kasi.fake');
