...
use Kasi\Http\Middleware\SetCacheHeaders as Cache;
...
class CacheTest extends TestCase
{
    public function testItCanGenerateDefinitionViaStaticMethod()
    {
        ...
        $this->assertSame('Kasi\Http\Middleware\SetCacheHeaders:max_age=120;no-transform;s_maxage=60;', $signature);
        ...
        $this->assertSame('Kasi\Http\Middleware\SetCacheHeaders:max_age=120;no-transform;s_maxage=60;etag', $signature);
