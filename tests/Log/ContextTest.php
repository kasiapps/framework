...
use Kasi\Log\Context\Events\ContextDehydrating as Dehydrating;
use Kasi\Log\Context\Events\ContextHydrated as Hydrated;
use Kasi\Log\Context\Repository;
...
class ContextTest extends TestCase
{
    ...
    public function test_it_can_serialize_values()
    {
        ...
        $this->assertSame([
            'data' => [
                ...
                'enum' => 'E:31:"Kasi\Tests\Log\Suit:Clubs";',
                'backed_enum' => 'E:43:"Kasi\Tests\Log\StringBackedSuit:Clubs";',
            ],
            'hidden' => [
                'number' => 'i:55;',
            ],
    ...
    {
        $path = storage_path('logs/kasi.log');
        ...
        $log = Str::after(file_get_contents(storage_path('logs/kasi.log')), '] ');

        $this->assertSame('testing.INFO: My name is Tim {"name":"Tim","framework":"Kasi"} {"trace_id":"expected-trace-id","foo.bar":123,"bar.baz":[456,789]}', trim($log));
