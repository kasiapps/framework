...
use Kasi\Container\EntryNotFoundException;
...
class ContainerTest extends TestCase
{
    ...
    public function testInternalClassWithDefaultParameters()
    {
        ...
        $this->expectExceptionMessage('Unresolvable dependency resolving [Parameter #0 [ <required> $first ]] in class Kasi\Tests\Container\ContainerMixedPrimitiveStub');
    ...
    {
        $this->expectException(BindingResolutionException::class);
        $this->expectExceptionMessage('Target [Kasi\Tests\Container\IContainerContractStub] is not instantiable.');
    ...
    {
        $this->expectException(BindingResolutionException::class);
        $this->expectExceptionMessage('Target [Kasi\Tests\Container\IContainerContractStub] is not instantiable while building [Kasi\Tests\Container\ContainerDependentStub].');
    ...
    // {
    //     $this->expectException(\Kasi\Contracts\Container\CircularDependencyException::class);
