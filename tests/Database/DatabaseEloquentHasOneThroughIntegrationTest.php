...
class DatabaseEloquentHasOneThroughIntegrationTest extends TestCase
{
    ...
    public function testFirstOrFailThrowsAnException()
    {
        ...
        $this->expectExceptionMessage('No query results for model [Kasi\Tests\Database\HasOneThroughTestContract].');
    ...
    public function testChunkReturnsCorrectModels()
    {
        ...
        $position->contract()->chunk(10, function ($contractsChunk) {
            ...
            $this->assertEquals([
                ...
                'created_at',
                'updated_at',
                'kasi_through_key', ], array_keys($contract->getAttributes()));
        });
    }
    ...
    /**
     * Migrate tables for classes with a Kasi "default" HasOneThrough setup.
     */
