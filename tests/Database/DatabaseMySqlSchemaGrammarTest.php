...
use Kasi\Tests\Database\Fixtures\Enums\Foo;
use Mockery as m;
...
class DatabaseMySqlSchemaGrammarTest extends TestCase
{
    ...
    public function testAddingForeignID()
    {
        ...
        $this->assertSame([
            ...
            'alter table `users` add `kasi_idea_id` bigint unsigned not null',
            'alter table `users` add constraint `users_kasi_idea_id_foreign` foreign key (`kasi_idea_id`) references `kasi_ideas` (`id`)',
    ...
    public function testAddingForeignUuid()
    {
        ...
        $this->assertSame([
            ...
            'alter table `users` add constraint `users_company_id_foreign` foreign key (`company_id`) references `companies` (`id`)',
            'alter table `users` add `kasi_idea_id` char(36) not null',
            'alter table `users` add constraint `users_kasi_idea_id_foreign` foreign key (`kasi_idea_id`) references `kasi_ideas` (`id`)',
