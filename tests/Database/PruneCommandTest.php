...
use Kasi\Database\Console\PruneCommand;
use Kasi\Database\Eloquent\MassPrunable;
use Kasi\Database\Eloquent\Model;
use Kasi\Database\Eloquent\Prunable;
use Kasi\Database\Eloquent\SoftDeletes;
use Kasi\Database\Events\ModelPruningFinished;
use Kasi\Database\Events\ModelPruningStarting;
use Kasi\Database\Events\ModelsPruned;
...
class PruneCommandTest extends TestCase
{
    ...
    public function testPrunableModelWithPrunableRecords()
    {
        ...
        $this->assertStringContainsString(
            'Kasi\Tests\Database\PrunableTestModelWithPrunableRecords',
            $output,
        );
    ...
    public function testPrunableTestModelWithoutPrunableRecords()
    {
        ...
        $this->assertStringContainsString(
            'No prunable [Kasi\Tests\Database\PrunableTestModelWithoutPrunableRecords] records found.',
            $output->fetch()
        );
    }
    ...
    public function testPrunableSoftDeletedModelWithPrunableRecords()
    {
        ...
        $this->assertStringContainsString(
            'Kasi\Tests\Database\PrunableTestSoftDeletedModelWithPrunableRecords',
            $output,
        );
    ...
    public function testNonPrunableTest()
    {
        ...
        $this->assertStringContainsString(
            'No prunable [Kasi\Tests\Database\NonPrunableTestModel] records found.',
            $output->fetch(),
        );
    }
    ...
    public function testTheCommandMayBePretended()
    {
        ...
        $this->assertStringContainsString(
            '3 [Kasi\Tests\Database\PrunableTestModelWithPrunableRecords] records will be pruned.',
            $output->fetch(),
        );
    ...
    public function testTheCommandMayBePretendedOnSoftDeletedModel()
    {
        ...
        $this->assertStringContainsString(
            '2 [Kasi\Tests\Database\PrunableTestSoftDeletedModelWithPrunableRecords] records will be pruned.',
            $output->fetch(),
        );
    ...
    protected function artisan($arguments)
    {
        ...
        tap(new PruneCommand())
            ->setKasi(Application::getInstance())
            ->run($input, $output);
