...
use Kasi\Database\Eloquent\Factories\CrossJoinSequence;
use Kasi\Database\Eloquent\Factories\Factory;
use Kasi\Database\Eloquent\Factories\HasFactory;
use Kasi\Database\Eloquent\Factories\Sequence;
...
class DatabaseEloquentFactoryTest extends TestCase
{
    ...
    public function test_resolve_nested_model_name_from_factory()
    {
        ...
        $app->shouldReceive('getNamespace')->andReturn('Kasi\\Tests\\Database\\Fixtures\\');

        Factory::useNamespace('Kasi\\Tests\\Database\\Fixtures\\Factories\\');
