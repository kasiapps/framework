...
class DatabaseEloquentCollectionTest extends TestCase
{
    ...
    public function testFindOrFailFindsManyModelsById()
    {
        ...
        $this->expectExceptionMessage('No query results for model [Kasi\Tests\Database\TestEloquentCollectionModel] 3');
    ...
    public function testFindOrFailThrowsExceptionWithMessageWhenOtherModelsArePresent()
    {
        ...
        $this->expectException(ModelNotFoundException::class);
        $this->expectExceptionMessage('No query results for model [Kasi\Tests\Database\TestEloquentCollectionModel] 2');
