...
class DatabaseEloquentHasManyThroughIntegrationTest extends TestCase
{
    ...
    public function testFirstOrFailThrowsAnException()
    {
        ...
        $this->expectExceptionMessage('No query results for model [Kasi\Tests\Database\HasManyThroughTestPost].');
    ...
    {
        $this->expectException(ModelNotFoundException::class);
        $this->expectExceptionMessage('No query results for model [Kasi\Tests\Database\HasManyThroughTestPost] 1');
    ...
    {
        $this->expectException(ModelNotFoundException::class);
        $this->expectExceptionMessage('No query results for model [Kasi\Tests\Database\HasManyThroughTestPost] 1, 2');
    ...
    /**
     * Migrate tables for classes with a Kasi "default" HasManyThrough setup.
     */
