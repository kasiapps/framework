...
use Kasi\Database\Schema\Builder;
use Kasi\Database\Schema\ForeignIdColumnDefinition;
use Kasi\Database\Schema\Grammars\PostgresGrammar;
use Mockery as m;
...
class DatabasePostgresSchemaGrammarTest extends TestCase
{
    ...
    public function testAddingForeignID()
    {
        ...
        $this->assertSame([
            ...
            'alter table "users" add column "kasi_idea_id" bigint not null',
    ...
    public function testAddingForeignUuid()
    {
        ...
        $this->assertSame([
            ...
            'alter table "users" add constraint "users_company_id_foreign" foreign key ("company_id") references "companies" ("id")',
            'alter table "users" add column "kasi_idea_id" uuid not null',
            'alter table "users" add constraint "users_kasi_idea_id_foreign" foreign key ("kasi_idea_id") references "kasi_ideas" ("id")',
