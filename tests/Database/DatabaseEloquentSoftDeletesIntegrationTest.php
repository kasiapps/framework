...
class DatabaseEloquentSoftDeletesIntegrationTest extends TestCase
{
    ...
    public function testUpdateModelAfterSoftDeleting()
    {
        ...
        /** @var \Kasi\Tests\Database\SoftDeletesTestUser $userModel */
    ...
    public function testHasOneRelationshipCanBeSoftDeleted()
    {
        ...
        $abigail->address()->create(['address' => 'Kasi avenue 43']);
        ...
        $this->assertSame('Kasi avenue 43', $abigail->address()->withTrashed()->first()->address);
        ...
        $this->assertSame('Kasi avenue 43', $abigail->address->address);
     ...
     * Helpers...
     *
     * @return \Kasi\Tests\Database\SoftDeletesTestUser[]
     */
