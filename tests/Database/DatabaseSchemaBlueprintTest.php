...
use Kasi\Tests\Database\Fixtures\Models\User;
use Mockery as m;
...
class DatabaseSchemaBlueprintTest extends TestCase
{
    ...
    public function testGenerateRelationshipColumnWithIncrementalModel()
    {
        $base = new Blueprint('posts', function ($table) {
            $table->foreignIdFor('Kasi\Foundation\Auth\User');
        });
    ...
    {
        $base = new Blueprint('posts', function ($table) {
            $table->foreignIdFor('Kasi\Foundation\Auth\User')->constrained();
        });
    ...
    {
        $base = new Blueprint('posts', function ($table) {
            $table->dropForeignIdFor('Kasi\Foundation\Auth\User');
        });
    ...
    {
        $base = new Blueprint('posts', function ($table) {
            $table->dropConstrainedForeignIdFor('Kasi\Foundation\Auth\User');
        });
