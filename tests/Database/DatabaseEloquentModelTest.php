...
use Kasi\Contracts\Database\Eloquent\CastsInboundAttributes;
use Kasi\Contracts\Encryption\Encrypter;
use Kasi\Contracts\Events\Dispatcher;
use Kasi\Database\Connection;
use Kasi\Database\ConnectionResolverInterface;
use Kasi\Database\ConnectionResolverInterface as Resolver;
use Kasi\Database\Eloquent\Attributes\CollectedBy;
use Kasi\Database\Eloquent\Attributes\ObservedBy;
use Kasi\Database\Eloquent\Attributes\UseFactory;
use Kasi\Database\Eloquent\Builder;
use Kasi\Database\Eloquent\Casts\ArrayObject;
use Kasi\Database\Eloquent\Casts\AsArrayObject;
use Kasi\Database\Eloquent\Casts\AsCollection;
use Kasi\Database\Eloquent\Casts\AsEncryptedArrayObject;
use Kasi\Database\Eloquent\Casts\AsEncryptedCollection;
use Kasi\Database\Eloquent\Casts\AsEnumArrayObject;
use Kasi\Database\Eloquent\Casts\AsEnumCollection;
use Kasi\Database\Eloquent\Casts\AsStringable;
use Kasi\Database\Eloquent\Casts\Attribute;
use Kasi\Database\Eloquent\Collection;
use Kasi\Database\Eloquent\Concerns\HasUlids;
use Kasi\Database\Eloquent\Concerns\HasUuids;
use Kasi\Database\Eloquent\Factories\Factory;
use Kasi\Database\Eloquent\Factories\HasFactory;
use Kasi\Database\Eloquent\JsonEncodingException;
use Kasi\Database\Eloquent\MassAssignmentException;
...
use Kasi\Database\Query\Builder as BaseBuilder;
use Kasi\Database\Query\Grammars\Grammar;
use Kasi\Database\Query\Processors\Processor;
...
class DatabaseEloquentModelTest extends TestCase
{
    ...
    public function testOnly()
    {
        ...
        $this->assertEquals(['project' => 'kasi'], $model->only('project'));
    ...
    {
        $model = $this->getMockBuilder('Kasi\Tests\Database\EloquentDateModelStub')->onlyMethods(['getDateFormat'])->getMock();
    ...
    public function testModelObserversCanBeAttachedToModels()
    {
        ...
        $events->shouldReceive('listen')->once()->with('eloquent.creating: Kasi\Tests\Database\EloquentModelStub', EloquentTestObserverStub::class.'@creating');
        $events->shouldReceive('listen')->once()->with('eloquent.saved: Kasi\Tests\Database\EloquentModelStub', EloquentTestObserverStub::class.'@saved');
    ...
    public function testModelObserversCanBeAttachedToModelsWithStringUsingAttribute()
    {
        ...
        $events->shouldReceive('dispatch');
        $events->shouldReceive('listen')->once()->with('eloquent.creating: Kasi\Tests\Database\EloquentModelWithObserveAttributeStub', EloquentTestObserverStub::class.'@creating');
        $events->shouldReceive('listen')->once()->with('eloquent.saved: Kasi\Tests\Database\EloquentModelWithObserveAttributeStub', EloquentTestObserverStub::class.'@saved');
        $events->shouldReceive('forget');
    ...
    public function testModelObserversCanBeAttachedToModelsThroughAnArrayUsingAttribute()
    {
        ...
        $events->shouldReceive('dispatch');
        $events->shouldReceive('listen')->once()->with('eloquent.creating: Kasi\Tests\Database\EloquentModelWithObserveAttributeUsingArrayStub', EloquentTestObserverStub::class.'@creating');
        $events->shouldReceive('listen')->once()->with('eloquent.saved: Kasi\Tests\Database\EloquentModelWithObserveAttributeUsingArrayStub', EloquentTestObserverStub::class.'@saved');
        $events->shouldReceive('forget');
    ...
    public function testModelObserversCanBeAttachedToModelsThroughAttributesOnParentClasses()
    {
        ...
        $events->shouldReceive('dispatch');
        $events->shouldReceive('listen')->once()->with('eloquent.creating: Kasi\Tests\Database\EloquentModelWithObserveAttributeGrandchildStub', EloquentTestObserverStub::class.'@creating');
        $events->shouldReceive('listen')->once()->with('eloquent.saved: Kasi\Tests\Database\EloquentModelWithObserveAttributeGrandchildStub', EloquentTestObserverStub::class.'@saved');
        $events->shouldReceive('listen')->once()->with('eloquent.creating: Kasi\Tests\Database\EloquentModelWithObserveAttributeGrandchildStub', EloquentTestAnotherObserverStub::class.'@creating');
        $events->shouldReceive('listen')->once()->with('eloquent.saved: Kasi\Tests\Database\EloquentModelWithObserveAttributeGrandchildStub', EloquentTestAnotherObserverStub::class.'@saved');
        $events->shouldReceive('listen')->once()->with('eloquent.creating: Kasi\Tests\Database\EloquentModelWithObserveAttributeGrandchildStub', EloquentTestThirdObserverStub::class.'@creating');
        $events->shouldReceive('listen')->once()->with('eloquent.saved: Kasi\Tests\Database\EloquentModelWithObserveAttributeGrandchildStub', EloquentTestThirdObserverStub::class.'@saved');
        $events->shouldReceive('forget');
    ...
    public function testModelObserversCanBeAttachedToModelsThroughCallingObserveMethodOnlyOnce()
    {
        ...
        $events->shouldReceive('listen')->once()->with('eloquent.creating: Kasi\Tests\Database\EloquentModelStub', EloquentTestAnotherObserverStub::class.'@creating');
        $events->shouldReceive('listen')->once()->with('eloquent.saved: Kasi\Tests\Database\EloquentModelStub', EloquentTestAnotherObserverStub::class.'@saved');
    ...
    public function testWithoutEventDispatcher()
    {
        ...
        $events->shouldReceive('listen')->once()->with('eloquent.creating: Kasi\Tests\Database\EloquentModelSaveStub', EloquentTestObserverStub::class.'@creating');
        $events->shouldReceive('listen')->once()->with('eloquent.saved: Kasi\Tests\Database\EloquentModelSaveStub', EloquentTestObserverStub::class.'@saved');
        ...
        $events->shouldReceive('until')->once()->with('eloquent.saving: Kasi\Tests\Database\EloquentModelSaveStub', $model);
        $events->shouldReceive('dispatch')->once()->with('eloquent.saved: Kasi\Tests\Database\EloquentModelSaveStub', $model);
    ...
    public function testGetModelAttributeMethodThrowsExceptionIfNotRelation()
    {
        ...
        $this->expectExceptionMessage('Kasi\Tests\Database\EloquentModelStub::incorrectRelationStub must return a relationship instance.');
    ...
    public function testModelAttributeCastingFailsOnUnencodableData()
    {
        ...
        $this->expectExceptionMessage('Unable to encode attribute [objectAttribute] for model [Kasi\Tests\Database\EloquentModelCastingStub] to JSON: Malformed UTF-8 characters, possibly incorrectly encoded.');
