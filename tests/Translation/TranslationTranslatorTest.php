...
class TranslationTranslatorTest extends TestCase
{
    ...
    public function testGetJsonReplacesWithStringable()
    {
        ...
        $t->stringable(function (\Kasi\Support\Carbon $carbon) {
    ...
    public function testTagReplacements()
    {
        ...
        $this->assertSame(
            'We have some nice <a href="https://kasi.com/docs">documentation</a>',
            $t->get(
                'We have some nice <docs-link>documentation</docs-link>',
                [
                    'docs-link' => fn ($children) => "<a href=\"https://kasi.com/docs\">$children</a>",
                ]
            )
        );
    }
