...
use Kasi\View\Engines\CompilerEngine;
...
class ViewFactoryTest extends TestCase
{
    ...
    public function testComponentHandling()
    {
        ...
        $factory->slot('title');
        $factory->slot('website', 'kasi.com', []);
        echo 'title<hr>';
        $factory->endSlot();
        echo 'component';
        $contents = $factory->renderComponent();
        $this->assertSame('title<hr> component Taylor kasi.com', $contents);
    }
    ...
    {
        $factory = $this->getFactory();
        $factory->startComponent(new HtmlString('kasi.com'));
        $contents = $factory->renderComponent();
        $this->assertSame('kasi.com', $contents);
    }
