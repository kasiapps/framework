...
<?php $component = Kasi\Tests\View\Blade\ComponentStub::class::resolve(["foo" => "bar"] + (isset($attributes) && $attributes instanceof Kasi\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName(\'test\'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>'), $this->compiler->compileString('@component(\'Kasi\Tests\View\Blade\ComponentStub::class\', \'test\', ["foo" => "bar"])'));
    }
...
<?php endif; ?>'), $this->compiler->compileString('@endcomponentClass'));
    ...
    public function testPropsAreExtractedFromParentAttributesCorrectlyForClassComponents()
    {
        ...
        $template = $this->compiler->compileString('@component(\'Kasi\Tests\View\Blade\ComponentStub::class\', \'test\', ["foo" => "bar"])');
