...
class BladePhpStatementsTest extends AbstractBladeTestCase
{
    ...
    public function testUnclosedParenthesisForBladeTags()
    {
        ...
        $expected = "<span class=\"<?php echo \Kasi\Support\Arr::toCssClasses([]); ?>\"(['(']></span>";
    ...
    public function testNestedTagCalls()
    {
        ...
        $expected = '<span class="<?php echo \Kasi\Support\Arr::toCssClasses([\'k\' => @empty($v)]); ?>"></span>';
        $this->assertEquals($expected, $this->compiler->compileString($string));
        ...
        $expected = '<span class="<?php echo \Kasi\Support\Arr::toCssClasses([\'k\' => @empty($v), \'t\' => @empty($v1)]); ?>"></span>';
        $this->assertEquals($expected, $this->compiler->compileString($string));
        ...
        $expected = '<span class="<?php echo \Kasi\Support\Arr::toCssClasses([\'k\' => @empty($v), \'t\' => @empty($v1), \'r\' => @empty($v2)]); ?>"></span>';
        $this->assertEquals($expected, $this->compiler->compileString($string));
        ...
        $expected = '<span class="<?php echo \Kasi\Support\Arr::toCssClasses([\'k\' => @empty($v), \'t\' => @empty($v1), \'r\' => @empty($v2), \'l\' => \'l\']); ?>"></span><span class="<?php echo \Kasi\Support\Arr::toCssClasses([\'k\' => @empty($v)]); ?>"></span>';
        $this->assertEquals($expected, $this->compiler->compileString($string));
    }
