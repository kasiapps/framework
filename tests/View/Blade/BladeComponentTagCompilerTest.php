...
use Kasi\View\Compilers\ComponentTagCompiler;
use Kasi\View\Component;
use Kasi\View\ComponentAttributeBag;
...
class BladeComponentTagCompilerTest extends AbstractBladeTestCase
{
    ...
    public function testSlotsWithDynamicAttributesCanBeCompiled()
    {
        ...
        $this->assertSame(
            "@slot('foo', null, ['class' => \Kasi\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\$classes)]) \n".' @endslot',
            str_replace("\r\n", "\n", trim($result))
        );
    }
    ...
    public function testSlotsWithClassDirectiveCanBeCompiled()
    {
        ...
        $this->assertSame(
            "@slot('foo', null, ['class' => \Kasi\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\Kasi\Support\Arr::toCssClasses(\$classes))]) \n".' @endslot',
            str_replace("\r\n", "\n", trim($result))
        );
    }
    ...
    public function testSlotsWithStyleDirectiveCanBeCompiled()
    {
        ...
        $this->assertSame(
            "@slot('foo', null, ['style' => \Kasi\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\Kasi\Support\Arr::toCssStyles(\$styles))]) \n".' @endslot',
            str_replace("\r\n", "\n", trim($result))
        );
    }
    ...
    public function testBasicComponentParsing()
    {
        ...
        $this->assertSame("<div>##BEGIN-COMPONENT-CLASS##@component('Kasi\Tests\View\Blade\TestAlertComponent', 'alert', [])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\Tests\View\Blade\TestAlertComponent::ignoredParameterNames()); ?>
<?php endif; ?>
...
"@endComponentClass##END-COMPONENT-CLASS####BEGIN-COMPONENT-CLASS##@component('Kasi\Tests\View\Blade\TestAlertComponent', 'alert', [])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\Tests\View\Blade\TestAlertComponent::ignoredParameterNames()); ?>
<?php endif; ?>
...
'@endComponentClass##END-COMPONENT-CLASS##</div>', trim($result));
    ...
    public function testDataCamelCasing()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Kasi\Tests\View\Blade\TestProfileComponent', 'profile', ['userId' => '1'])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\Tests\View\Blade\TestProfileComponent::ignoredParameterNames()); ?>
<?php endif; ?>
...
<?php \$component->withAttributes([]); ?> @endComponentClass##END-COMPONENT-CLASS##", trim($result));
    ...
    public function testColonDataShortSyntax()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Kasi\Tests\View\Blade\TestProfileComponent', 'profile', ['userId' => \$userId])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\Tests\View\Blade\TestProfileComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes([]); ?> @endComponentClass##END-COMPONENT-CLASS##", trim($result));
    ...
    public function testColonDataWithStaticClassProperty()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Kasi\Tests\View\Blade\TestProfileComponent', 'profile', ['userId' => User::\$id])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\Tests\View\Blade\TestProfileComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes([]); ?> @endComponentClass##END-COMPONENT-CLASS##", trim($result));
    ...
    public function testColonDataWithStaticClassPropertyAndMultipleAttributes()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Kasi\Tests\View\Blade\TestInputComponent', 'input', ['label' => Input::\$label,'name' => \$name,'value' => 'Joe'])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\Tests\View\Blade\TestInputComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes([]); ?> @endComponentClass##END-COMPONENT-CLASS##", trim($result));

        $result = $this->compiler(['input' => TestInputComponent::class])->compileTags('<x-input value="Joe" :$name :label="Input::$label"></x-input>');

        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Kasi\Tests\View\Blade\TestInputComponent', 'input', ['value' => 'Joe','name' => \$name,'label' => Input::\$label])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\Tests\View\Blade\TestInputComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes([]); ?> @endComponentClass##END-COMPONENT-CLASS##", trim($result));
...
'@endComponentClass##END-COMPONENT-CLASS##', trim($result));
    ...
    public function testSelfClosingComponentWithColonDataMultipleAttributesAndStaticClassPropertyShortSyntax()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Kasi\Tests\View\Blade\TestInputComponent', 'input', ['label' => Input::\$label,'value' => 'Joe','name' => \$name])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\Tests\View\Blade\TestInputComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes([]); ?>\n".
'@endComponentClass##END-COMPONENT-CLASS##', trim($result));
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Kasi\Tests\View\Blade\TestInputComponent', 'input', ['name' => \$name,'label' => Input::\$label,'value' => 'Joe'])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\Tests\View\Blade\TestInputComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes([]); ?>\n".
...
<?php \$component->withAttributes([':title' => 'user.name']); ?> @endComponentClass##END-COMPONENT-CLASS##", trim($result));
    ...
    public function testColonAttributesIsEscapedIfStrings()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Kasi\Tests\View\Blade\TestProfileComponent', 'profile', [])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\Tests\View\Blade\TestProfileComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes(['src' => \Kasi\View\Compilers\BladeCompiler::sanitizeComponentAttribute('foo')]); ?> @endComponentClass##END-COMPONENT-CLASS##", trim($result));
    }
...
<?php \$attributes = \$attributes->except(\Kasi\Tests\View\Blade\TestProfileComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes(['class' => \Kasi\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\Kasi\Support\Arr::toCssClasses(['bar'=>true]))]); ?> @endComponentClass##END-COMPONENT-CLASS##", trim($result));
    }
...
<?php \$attributes = \$attributes->except(\Kasi\Tests\View\Blade\TestProfileComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes(['style' => \Kasi\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\Kasi\Support\Arr::toCssStyles(['bar'=>true]))]); ?> @endComponentClass##END-COMPONENT-CLASS##", trim($result));
    }
    ...
    public function testColonNestedComponentParsing()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Kasi\Tests\View\Blade\TestAlertComponent', 'foo:alert', [])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\Tests\View\Blade\TestAlertComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes([]); ?> @endComponentClass##END-COMPONENT-CLASS##", trim($result));
...
'@endComponentClass##END-COMPONENT-CLASS##</div>', trim($result));
    ...
    public function testComponentsCanBeCompiledWithHyphenAttributes()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Kasi\Tests\View\Blade\TestAlertComponent', 'alert', [])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\Tests\View\Blade\TestAlertComponent::ignoredParameterNames()); ?>
<?php endif; ?>
...
'@endComponentClass##END-COMPONENT-CLASS##', trim($result));
    ...
    public function testSelfClosingComponentsCanBeCompiledWithDataAndAttributes()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Kasi\Tests\View\Blade\TestAlertComponent', 'alert', ['title' => 'foo'])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\Tests\View\Blade\TestAlertComponent::ignoredParameterNames()); ?>
<?php endif; ?>
...
<?php \$attributes = \$attributes->except(\Kasi\Tests\View\Blade\TestProfileComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes(['class' => 'bar','attributes' => \Kasi\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\$attributes),'wire:model' => 'foo']); ?> @endComponentClass##END-COMPONENT-CLASS##", trim($result));
    }
    ...
    public function testSelfClosingComponentCanReceiveAttributeBag()
    {
        ...
        $this->assertSame("<div>##BEGIN-COMPONENT-CLASS##@component('Kasi\Tests\View\Blade\TestAlertComponent', 'alert', ['title' => 'foo'])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\Tests\View\Blade\TestAlertComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes(['class' => 'bar','attributes' => \Kasi\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\$attributes->merge(['class' => 'test'])),'wire:model' => 'foo']); ?>\n".
            '@endComponentClass##END-COMPONENT-CLASS##</div>', trim($result));
    }
...
'@endComponentClass##END-COMPONENT-CLASS##Words', trim($result));
    ...
    public function testSelfClosingComponentsCanBeCompiledWithBoundData()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Kasi\Tests\View\Blade\TestAlertComponent', 'alert', ['title' => \$title])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\Tests\View\Blade\TestAlertComponent::ignoredParameterNames()); ?>
<?php endif; ?>
...
<?php \$component->withAttributes([]); ?>
 @endComponentClass##END-COMPONENT-CLASS##", trim($result));
    ...
    public function testClasslessComponents()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Kasi\View\AnonymousComponent', 'anonymous-component', ['view' => 'components.anonymous-component','data' => ['name' => 'Taylor','age' => 31,'wire:model' => 'foo']])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes(['name' => \Kasi\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Taylor'),'age' => 31,'wire:model' => 'foo']); ?>\n".
'@endComponentClass##END-COMPONENT-CLASS##', trim($result));
    }
    ...
    public function testClasslessComponentsWithIndexView()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Kasi\View\AnonymousComponent', 'anonymous-component', ['view' => 'components.anonymous-component.index','data' => ['name' => 'Taylor','age' => 31,'wire:model' => 'foo']])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes(['name' => \Kasi\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Taylor'),'age' => 31,'wire:model' => 'foo']); ?>\n".
'@endComponentClass##END-COMPONENT-CLASS##', trim($result));
    ...
    public function testClasslessComponentsWithComponentView()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Kasi\View\AnonymousComponent', 'anonymous-component', ['view' => 'components.anonymous-component.anonymous-component','data' => ['name' => 'Taylor','age' => 31,'wire:model' => 'foo']])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes(['name' => \Kasi\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Taylor'),'age' => 31,'wire:model' => 'foo']); ?>\n".
    ...
    public function testPackagesClasslessComponents()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Kasi\View\AnonymousComponent', 'package::anonymous-component', ['view' => 'package::components.anonymous-component','data' => ['name' => 'Taylor','age' => 31,'wire:model' => 'foo']])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes(['name' => \Kasi\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Taylor'),'age' => 31,'wire:model' => 'foo']); ?>\n".
'@endComponentClass##END-COMPONENT-CLASS##', trim($result));
    ...
    public function testClasslessComponentsWithAnonymousComponentNamespace()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Kasi\View\AnonymousComponent', 'frontend::anonymous-component', ['view' => 'public.frontend.anonymous-component','data' => ['name' => 'Taylor','age' => 31,'wire:model' => 'foo']])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes(['name' => \Kasi\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Taylor'),'age' => 31,'wire:model' => 'foo']); ?>\n".
    ...
    public function testClasslessComponentsWithAnonymousComponentNamespaceWithIndexView()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Kasi\View\AnonymousComponent', 'admin.auth::anonymous-component', ['view' => 'admin.auth.components.anonymous-component.index','data' => ['name' => 'Taylor','age' => 31,'wire:model' => 'foo']])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes(['name' => \Kasi\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Taylor'),'age' => 31,'wire:model' => 'foo']); ?>\n".
    ...
    public function testClasslessComponentsWithAnonymousComponentNamespaceWithComponentView()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Kasi\View\AnonymousComponent', 'admin.auth::anonymous-component', ['view' => 'admin.auth.components.anonymous-component.anonymous-component','data' => ['name' => 'Taylor','age' => 31,'wire:model' => 'foo']])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes(['name' => \Kasi\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Taylor'),'age' => 31,'wire:model' => 'foo']); ?>\n".
    ...
    public function testClasslessComponentsWithAnonymousComponentPath()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Kasi\View\AnonymousComponent', 'panel', ['view' => '".md5('test-directory')."::panel.index','data' => []])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes([]); ?>\n".
    ...
    public function testClasslessComponentsWithAnonymousComponentPathComponentName()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Kasi\View\AnonymousComponent', 'panel', ['view' => '".md5('test-directory')."::panel.panel','data' => []])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes([]); ?>\n".
    ...
    public function testClasslessIndexComponentsWithAnonymousComponentPath()
    {
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Kasi\View\AnonymousComponent', 'panel', ['view' => '".md5('test-directory')."::panel','data' => []])
<?php if (isset(\$attributes) && \$attributes instanceof Kasi\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Kasi\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes([]); ?>\n".
    ...
    public function testAttributesTreatedAsPropsAreRemovedFromFinalAttributes()
    {
        ...
        $__env = m::mock(\Kasi\View\Factory::class);
