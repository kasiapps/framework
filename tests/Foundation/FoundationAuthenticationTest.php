...
use Kasi\Foundation\Testing\Concerns\InteractsWithAuthentication;
use Mockery as m;
...
class FoundationAuthenticationTest extends TestCase
{
    ...
    protected $credentials = [
        'email' => 'someone@kasi.com',
        'password' => 'secret_password',
    ];

    /**
     * @return \Kasi\Contracts\Auth\Guard|\Mockery\LegacyMockInterface|\Mockery\MockInterface
     */
