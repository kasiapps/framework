...
use Kasi\Contracts\Validation\Factory as ValidationFactoryContract;
use Kasi\Contracts\Validation\Validator;
use Kasi\Foundation\Http\FormRequest;
use Kasi\Http\RedirectResponse;
use Kasi\Routing\Redirector;
use Kasi\Routing\UrlGenerator;
use Kasi\Validation\Factory as ValidationFactory;
...
class FoundationFormRequestTest extends TestCase
{
    ...
    public function testAfterMethod()
    {
        ...
        $container->instance(\Kasi\Contracts\Validation\Factory::class, (new \Kasi\Validation\Factory(
            new \Kasi\Translation\Translator(new \Kasi\Translation\ArrayLoader(), 'en')
     ...
     * @param  array  $payload
     * @param  string  $class
     * @return \Kasi\Foundation\Http\FormRequest
     */
     ...
     * @return \Kasi\Validation\Factory
     */
     ...
     * @return \Kasi\Routing\Redirector
     */
     ...
     *
     * @return \Kasi\Routing\UrlGenerator
     */
     ...
     *
     * @return \Kasi\Http\RedirectResponse
     */
