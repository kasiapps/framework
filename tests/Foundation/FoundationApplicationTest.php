...
use Kasi\Foundation\Bootstrap\RegisterFacades;
...
class FoundationApplicationTest extends TestCase
{
    ...
    public function testMethodAfterLoadingEnvironmentAddsClosure()
    {
        ...
        $this->assertArrayHasKey(0, $app['events']->getListeners('bootstrapped: Kasi\Foundation\Bootstrap\LoadEnvironmentVariables'));
    }
    ...
    public function testBeforeBootstrappingAddsClosure()
    {
        ...
        $this->assertArrayHasKey(0, $app['events']->getListeners('bootstrapping: Kasi\Foundation\Bootstrap\RegisterFacades'));
    }
    ...
    public function testAfterBootstrappingAddsClosure()
    {
        ...
        $this->assertArrayHasKey(0, $app['events']->getListeners('bootstrapped: Kasi\Foundation\Bootstrap\RegisterFacades'));
    }
    ...
    {
        $app1 = new Application(realpath(__DIR__.'/fixtures/kasi1'));
        $app2 = new Application(realpath(__DIR__.'/fixtures/kasi2'));

        $this->assertSame('Kasi\\One\\', $app1->getNamespace());
        $this->assertSame('Kasi\\Two\\', $app2->getNamespace());
    }
    ...
    public function testUseConfigPath(): void
    {
        ...
        $app->bootstrapWith([\Kasi\Foundation\Bootstrap\LoadConfiguration::class]);
