...
class FoundationHelpersTest extends TestCase
{
    ...
    {
        $path = $this->makeHotModuleReloadFile('https://kasi.com/docs');

        $result = mix('unversioned.css');

        $this->assertSame('//kasi.com/docs/unversioned.css', $result->toHtml());
    ...
    {
        $path = $this->makeHotModuleReloadFile('http://kasi.com/docs');
    ...
    {
        mkdir($directory = __DIR__.'/mix');
        $path = $this->makeHotModuleReloadFile('https://kasi.com/docs', 'mix');
    ...
    {
        mkdir($directory = __DIR__.'/mix');
        $path = $this->makeHotModuleReloadFile('http://kasi.com/docs', 'mix');
    ...
    protected function makeHotModuleReloadFile($url, $directory = '')
    {
        ...
        // Kasi mix when run 'hot' has a new line after the
    ...
    protected function makeManifest($directory = '')
    {
        ...
        // Kasi mix prints JSON pretty and with escaped
