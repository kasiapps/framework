...
beforeEach(function () {
    ...
    $this->mockApp = m::mock(); // Use different property name to avoid conflict with TestCase

    $this->mockApp->shouldReceive('make')->with('db')->andReturn($this->database);
});
