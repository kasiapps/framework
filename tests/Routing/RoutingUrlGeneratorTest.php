...
class RoutingUrlGeneratorTest extends TestCase
{
    ...
    public function testBasicGenerationWithRequestBaseUrlWithSubfolder()
    {
        ...
        $request->server->set('SCRIPT_FILENAME', '/var/www/kasi-project/public/subfolder/index.php');
    ...
    public function testBasicGenerationWithRequestBaseUrlWithFileSuffix()
    {
        ...
        $request->server->set('SCRIPT_FILENAME', '/var/www/kasi-project/public/other.php');
    ...
    {
        $this->markTestSkipped('See https://github.com/kasi/framework/pull/43255');
