...
class RouteRegistrarTest extends TestCase
{
    ...
    public function testCanRegisterGroupWithNamespace()
    {
        ...
        $this->assertSame(
            '\Kasi\Routing\RedirectController@__invoke',
            $this->getRoute()->getAction()['uses']
        );
    }
    ...
    public function testRouteGroupChaining()
    {
        ...
        $this->assertInstanceOf(\Kasi\Routing\Route::class, $routeCollection->match(Request::create('foo', 'GET')));
        $this->assertInstanceOf(\Kasi\Routing\Route::class, $routeCollection->match(Request::create('bar', 'GET')));
    }

    public function testRegisteringNonApprovedAttributesThrows()
    {
        $this->expectException(BadMethodCallException::class);
        $this->expectExceptionMessage('Method Kasi\Routing\RouteRegistrar::unsupportedMethod does not exist.');
