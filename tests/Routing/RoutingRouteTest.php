...
use DateTime;
use Exception;
use Kasi\Auth\Middleware\Authenticate;
use Kasi\Auth\Middleware\Authorize;
use Kasi\Config\Repository;
use Kasi\Container\Attributes\Config;
use Kasi\Container\Container;
use Kasi\Contracts\Routing\Registrar;
use Kasi\Contracts\Support\Responsable;
use Kasi\Database\Eloquent\Model;
use Kasi\Database\Eloquent\ModelNotFoundException;
use Kasi\Events\Dispatcher;
use Kasi\Http\Exceptions\HttpResponseException;
use Kasi\Http\JsonResponse;
use Kasi\Http\RedirectResponse;
use Kasi\Http\Request;
use Kasi\Http\Response;
use Kasi\Routing\CallableDispatcher;
use Kasi\Routing\Contracts\CallableDispatcher as CallableDispatcherContract;
use Kasi\Routing\Contracts\ControllerDispatcher as ControllerDispatcherContract;
use Kasi\Routing\Controller;
use Kasi\Routing\ControllerDispatcher;
use Kasi\Routing\Events\PreparingResponse;
use Kasi\Routing\Events\ResponsePrepared;
use Kasi\Routing\Events\Routing;
use Kasi\Routing\Exceptions\UrlGenerationException;
use Kasi\Routing\Middleware\SubstituteBindings;
use Kasi\Routing\ResourceRegistrar;
use Kasi\Routing\Route;
use Kasi\Routing\RouteCollection;
use Kasi\Routing\RouteGroup;
...
class RoutingRouteTest extends TestCase
{
    ...
    public function testModelBindingWithNullReturn()
    {
        ...
        $this->expectExceptionMessage('No query results for model [Kasi\Tests\Routing\RouteModelBindingNullStub].');
    ...
    public function testInvalidActionException()
    {
        ...
        $this->expectExceptionMessage('Invalid route action: [Kasi\Tests\Routing\RouteTestControllerStub].');
    ...
    public function testImplicitBindingsWithOptionalParameterUsingEnumIsAlwaysCastedToEnum()
    {
        ...
        $router->get('foo/{bar?}', [
            'middleware' => SubstituteBindings::class,
            'uses' => function (?\Kasi\Tests\Routing\CategoryBackedEnum $bar = null) {
    ...
    public function testRouteRedirectExceptionWhenMissingExpectedParameters()
    {
        ...
        $this->expectExceptionMessage('Missing required parameter for [Route: kasi_route_redirect_destination] [URI: users/{user}] [Missing parameter: user].');
