...
use Kasi\Auth\Access\AuthorizationException;
use Kasi\Auth\Access\Gate;
use Kasi\Auth\Access\HandlesAuthorization;
use Kasi\Auth\Access\Response;
...
class AuthAccessGateTest extends TestCase
{
    ...
    {
        unset($_SERVER['__kasi.testBefore']);
        ...
        $this->assertTrue($_SERVER['__kasi.testBefore']);
    ...
    {
        $_SERVER['__kasi.testBefore'] = false;
        ...
        $this->assertTrue($gate->check('edit', new AccessGateTestDummy));
        $this->assertFalse($gate->check('update', new AccessGateTestDummy));
        $this->assertFalse($_SERVER['__kasi.testBefore']);
    ...
    {
        $_SERVER['__kasi.gateBefore'] = false;
        $_SERVER['__kasi.gateBefore2'] = false;
        $_SERVER['__kasi.gateAfter'] = false;
        $_SERVER['__kasi.gateAfter2'] = false;
        ...
        $gate->before(function (?stdClass $user) {
            $_SERVER['__kasi.gateBefore'] = true;
        });

        $gate->after(function (?stdClass $user) {
            $_SERVER['__kasi.gateAfter'] = true;
        });

        $gate->before(function (stdClass $user) {
            $_SERVER['__kasi.gateBefore2'] = true;
        });

        $gate->after(function (stdClass $user) {
            $_SERVER['__kasi.gateAfter2'] = true;
        });
        ...
        $this->assertTrue($_SERVER['__kasi.gateBefore']);
        $this->assertFalse($_SERVER['__kasi.gateBefore2']);
        $this->assertTrue($_SERVER['__kasi.gateAfter']);
        $this->assertFalse($_SERVER['__kasi.gateAfter2']);

        unset(
            $_SERVER['__kasi.gateBefore'],
            $_SERVER['__kasi.gateBefore2'],
            $_SERVER['__kasi.gateAfter'],
            $_SERVER['__kasi.gateAfter2']
        );
    }
...
class AccessGateTestPolicyThatAllowsGuests
{
    ...
    {
        $_SERVER['__kasi.testBefore'] = true;
    }
