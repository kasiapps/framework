...
class AuthorizeMiddlewareTest extends TestCase
{
    ...
    public function testItCanGenerateDefinitionViaStaticMethod()
    {
        ...
        $this->assertSame('Kasi\Auth\Middleware\Authorize:ability', $signature);

        $signature = (string) Authorize::using('ability', 'model');
        $this->assertSame('Kasi\Auth\Middleware\Authorize:ability,model', $signature);

        $signature = (string) Authorize::using('ability', 'model', \App\Models\Comment::class);
        $this->assertSame('Kasi\Auth\Middleware\Authorize:ability,model,App\Models\Comment', $signature);
    }
