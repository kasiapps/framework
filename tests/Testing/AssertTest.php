...
use Kasi\Testing\Exceptions\InvalidArgumentException;
...
class AssertTest extends TestCase
{
    ...
    public function testArraySubsetMayFailIfArrayIsNotArray()
    {
        ...
        $this->expectExceptionMessage(
            'Argument #1 of Kasi\Testing\Assert::assertArraySubset() must be an array or ArrayAccess'
        );
    ...
    public function testArraySubsetMayFailIfSubsetIsNotArray()
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage(
            'Argument #2 of Kasi\Testing\Assert::assertArraySubset() must be an array or ArrayAccess'
        );
