...
class TestResponseTest extends TestCase
{
    ...
    {
        $response = $this->makeMockResponse([
            'render' => 'kasi &amp; php &amp; friends',
        ]);

        $response->assertSee('kasi & php');
        $response->assertSee(['php & friends', 'kasi & php']);
    }
    ...
    public function testAssertSeeTextEscaped()
    {
        ...
        $response->assertSeeText('kasi & php');
        $response->assertSeeText(['php & friends', 'kasi & php']);
    }
    ...
    {
        $response = $this->makeMockResponse([
            'render' => '<strong>kasi &amp; php</strong> <i>phpstorm &gt; sublime</i>',
        ]);

        $response->assertSeeTextInOrder(['kasi & php', 'phpstorm > sublime']);
    }
    ...
    public function testAssertDontSeeEscapedCanFail()
    {
        ...
        $response->assertDontSee('kasi & php');
        $response->assertDontSee(['php & friends', 'kasi & php']);
    }
    ...
    public function testAssertDontSeeHtml()
    {
        ...
        $response->assertDontSeeHtml('<li>kasi</li>');
    ...
    public function testAssertDontSeeText()
    {
        ...
        $response->assertDontSeeText('kasiphp');
        $response->assertDontSeeText(['phpfriends', 'kasiphp']);
    }
    ...
    public function testAssertDontSeeTextEscapedCanFail()
    {
        ...
        $response->assertDontSeeText('kasi & php');
        $response->assertDontSeeText(['php & friends', 'kasi & php']);
    }
